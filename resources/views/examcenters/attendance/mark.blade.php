...
<div class="container">
	<div class="row">
		<div class="col-12">
            <h3>Sept-Oct 2023 Examinations - Mark the attendance
            </h3>
            ...
            <br>
            <form action="{{url('examcenter/saveattendance')}}" method="post">
                {{csrf_field()}}
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <td>
                                    ...
                                    <input type="text" id="ansbookno_{{$a->id}}" name="ansbookno_{{$a->id}}"  value="{{$a->dummy_number}}" disabled> 
                                </td>
                        </tr>
                    @endforeach
                </table>
