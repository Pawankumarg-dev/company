...
@endif
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                @foreach($approvedprogrammes  as $ap)
                    <?php $application = \App\Currentapplication::where('approvedprogramme_id',$ap->id)->whereHas('subject',function($q) use ($examdate, $starttime){
                        ...
                        })->with('candidate')->with('subject')->first(); ?>
