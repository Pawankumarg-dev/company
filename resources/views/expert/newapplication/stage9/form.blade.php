        ...
        <div class="row">
            <div class="col-sm-12 well well-sm white-background minus15px-margin-top">
                <form class="form-horizontal" role="form" method="POST"
                      action="{{url('/expert/application/new/checkstage9')}}" autocomplete="off" accept-charset="UTF-8"
                    ...
                    <div class="form-group {{ $errors->has('pancard_no') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="pancard_no" name="pancard_no" placeholder="Enter PAN Card Number" value="{{ old('pancard_no') }}"/>
                            <script>
                    ...
                    <div class="form-group {{ $errors->has('bank_account_no') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-3">
                            <input type="number" class="form-control" id="bank_account_no" name="bank_account_no" placeholder="Enter Bank Account Number" value="{{ old('bank_account_no') }}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group {{ $errors->has('bank_ifsc_code') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="bank_ifsc_code" name="bank_ifsc_code" placeholder="Enter Bank IFSC Code" value="{{ old('bank_ifsc_code') }}"/>
                            <script>
                                $(document).ready(function () {
                    ...
                    <div class="form-group {{ $errors->has('bank_branch_name') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="bank_branch_name" name="bank_branch_name" placeholder="Enter Bank Branch Name" value="{{ old('bank_branch_name') }}"/>
                            <script>
                                $(document).ready(function () {
