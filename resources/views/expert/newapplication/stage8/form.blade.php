        ...
        <div class="row">
            <div class="col-sm-12 well well-sm white-background minus15px-margin-top">
                <form class="form-horizontal" role="form" method="POST"
                      action="{{url('/expert/application/new/checkstage8languages')}}" autocomplete="off" accept-charset="UTF-8"
                    ...
                    <script>
                        $(document).ready(function () {
                            $(".selectspeak").prop('disabled', true);
                            $(".selectread").prop('disabled', true);
                            $(".selectwrite").prop('disabled', true);

                            $("#selectall").click(function () {
                                $(".selectcheckbox").prop('checked', $(this).prop('checked'));

                                if($(this).prop("checked")) {
                                    $(".selectspeak").prop('disabled', false);
                                    $(".selectread").prop('disabled', false);
                                    $(".selectwrite").prop('disabled', false);
                                }
                                else {
                                    $(".selectspeak").prop('disabled', true);
                                    $(".selectread").prop('disabled', true);
                        ...
                        function enablefield() {
                            var languagecheckboxes = document.getElementsByClassName("selectcheckbox");
                            var selectspeaks = document.getElementsByClassName("selectspeak");

                            for(var i=0; i<languagecheckboxes.length; i++) {
                                if(languagecheckboxes[i].checked) {
                                    selectspeaks[i].checked = true;
                                    selectspeaks[i].disable = false;
                                }
                                else {
                                    selectspeaks[i].checked = false;
                                }
                            }
