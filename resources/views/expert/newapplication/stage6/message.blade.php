        ...
        <div class="row">
            <div class="col-sm-12 well well-sm white-background minus15px-margin-top">
                <table class="table table-stripped table-bordered table-condensed">
                    <tr>
                        <td class="center-text green-text" colspan="2">You have successfully completed the
                            <b>Stage 6 of the Online Expert Pool Application</b>
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="table table-bordered table-condensed table-responsive">
                    ...
                    @if($expertteachingexperiences->count() == "0")
                        <tr>
                    ...
                    @else
                        ...
                        @foreach($expertteachingexperiences as $ete)
                            <tr>
                                ...
                                <td class="left-text">
                                    Category: {{ $ete->organization_category }}<br>Type: {{ $ete->organization_type }}
                                </td>
                ...
                <a href="{{ url('/expert/application/new/applystage7/'.$expert->id) }}" class="btn btn-info">Click here to apply for Stage-VII</a>
