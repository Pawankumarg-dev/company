        ...
        <div class="row">
            <div class="col-sm-12 well well-sm white-background minus15px-margin-top">
                <form class="form-horizontal" role="form" method="POST"
                      action="{{url('/expert/application/new/checkstage1/')}}" autocomplete="off" accept-charset="UTF-8"
                    ...
                    <div class="form-group {{ $errors->has('relation_name') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="relation_name" name="relation_name" placeholder="Enter Father's \ Mother's \ Husband's \ Guardian's Name"  value="{{ old('relation_name') }}"/>
                                    <script>
                                        $(document).ready(function () {
                    ...
                    <div class="form-group {{ $errors->has('dob') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-3">
                            <div class='input-group date' id='dob_datetimepicker'>
                                <input type='text' class="form-control" placeholder="Choose Date of Birth" id="dob" name="dob"  value="{{ old('dob') }}"/>
                    ...
                    <div class="form-group {{ $errors->has('has_disability') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                            <div class="row">
                                <div class="col-sm-3">
                                    <label class="radio-inline"><input type="radio" name="has_disability" value="Yes">Yes</label>
                                    <label class="radio-inline"><input type="radio" name="has_disability" value="No">No</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group {{ $errors->has('contactnumber1') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-3">
                            <input type="number" class="form-control" id="contactnumber1" name="contactnumber1" placeholder="Enter Mobile Number"  value="{{ old('contactnumber1') }}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group {{ $errors->has('contactnumber2') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-3">
                            <input type="number" class="form-control" id="contactnumber2" name="contactnumber2" placeholder="Enter Alternate Mobile Number"  value="{{ old('contactnumber2') }}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-6">
                            <input type="email" class="form-control" id="email" name="email" placeholder="Enter Email ID"  value="{{ old('email') }}"/>
                            <script>
                                $(document).ready(function () {
                    ...
                    <div class="form-group {{ $errors->has('aadhaarcard_no') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-3">
                            <input type="number" class="form-control" id="aadhaarcard_no" name="aadhaarcard_no" placeholder="Enter Aadhaar Card Number"  value="{{ old('aadhaarcard_no') }}"/>
                        </div>
                    </div>
