        ...
        <div class="row">
            <div class="col-sm-12 well well-sm white-background minus15px-margin-top">
                <form class="form-horizontal" role="form" method="POST"
                      action="{{url('/expert/application/new/checkstage3qualifications')}}" autocomplete="off" accept-charset="UTF-8"
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <select class="form-control" name="course_type">
                                        ...
                                        <option value="Post-Graduation Course">Post-Graduation Course</option>
                                        <option value="Post-Graduation Diploma Course">Post-Graduation Diploma Course</option>
                                        <option value="Ph.D Course">Ph.D Course</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group {{ $errors->has('course_name') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="course_name" name="course_name" placeholder="Enter Course Name" value="{{ old('course_name') }}"/>
                            <script>
                    ...
                    <div class="form-group {{ $errors->has('institute_name') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="institute_name" name="institute_name"  placeholder="Enter Institute / Study Center Name"  value="{{ old('institute_name') }}"/>
                            <script>
                                $(document).ready(function () {
                    ...
                    <div class="form-group {{ $errors->has('exambody_name') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="exambody_name" name="exambody_name" placeholder="Enter University / Examination Body Name" value="{{ old('exambody_name') }}"/>
                            <script>
                                $(document).ready(function () {
                    ...
                    <div class="form-group {{ $errors->has('course_complete_year') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-3">
                            <div class='input-group date' id='year_datetimepicker'>
                                <input type='text' class="form-control" placeholder="Choose Course Completion Year" id="course_complete_year" name="course_complete_year"  value="{{ old('course_complete_year') }}"/>
                    ...
                    <div class="form-group {{ $errors->has('certificate_no') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="certificate_no" name="certificate_no" placeholder="Enter Certificate Number" value="{{ old('certificate_no') }}"/>
                        </div>
                    </div>
