        ...
        <div class="row">
            <div class="col-sm-12 well well-sm white-background minus15px-margin-top">
                <div class="center-text bold-text">
                    Stage 4 - RCI Professional Qualification
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12 well well-sm white-background minus15px-margin-top">
                <form class="form-horizontal" role="form" method="POST"
                      action="{{url('/expert/application/new/checkstage4qualifications')}}" autocomplete="off" accept-charset="UTF-8"
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control" name="rcicourse_id">
                                        ...
                                        @foreach($rcicourses as $r)
                                            <option value="{{ $r->id }}"> ({{ $r->mode }}),  {{ $r->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
