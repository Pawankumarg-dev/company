        ...
        <div class="row">
            <div class="col-sm-12 well well-sm white-background minus15px-margin-top">
                <form class="form-horizontal" role="form" method="POST"
                      action="{{url('/expert/application/edit/stage5/updateform')}}" autocomplete="off" accept-charset="UTF-8"
                    ...
                    <div id="yesfield">
                        <div class="form-group {{ $errors->has('crr_no') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" id="crr_no" name="crr_no"  placeholder="Enter CRR Number"  value="{{ $expert->crr_no }}"/>
                                <script>
                                    $(document).ready(function () {
                        ...
                        <div class="form-group {{ $errors->has('crr_no_issued_year') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-3">
                                <div class='input-group date' id='year1_datetimepicker'>
                                    <input type='text' class="form-control" placeholder="Choose CRR No Issued Year" id="crr_no_issued_year" name="crr_no_issued_year"  value="{{ $expert->crr_no_issued_year }}"/>
                                    ...
                                    <script type="text/javascript">
                                        $(function () {
                                            $('#year1_datetimepicker').datetimepicker({
                                                viewMode: 'years',
                                                format: 'YYYY'
                                            });
                                        });
                        ...
                        <div class="form-group {{ $errors->has('crr_no_expiry_year') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-3">
                                <div class='input-group date' id='year2_datetimepicker'>
                                    <input type='text' class="form-control" placeholder="Choose CRR No Expiry Year" id="crr_no_expiry_year" name="crr_no_expiry_year"  value="{{ $expert->crr_no_expiry_year }}"/>
                                    <div class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </div>
