                        ...
                        <tr>
                            <th class="grey-background" colspan="9">
                                ...
                                <div class="right-text">
                                    <a href="{{ url('/expert/application/edit/stage4/addform/'.$expert->id) }}" class="btn btn-success btn-sm">Add Qualification</a>
                                </div>
                            </th>
                        </tr>
                        <tr>
                        ...
                        @foreach($expert->expertrciqualifications as $eq)
                            <tr>
                                ...
                                <td class="center-text blue-text">
                                    <div class="center-text">
                                        <a href="{{ url('/expert/application/edit/stage4/form/'.$eq->id) }}" class="btn btn-info btn-xs">Edit</a>
                                        <a href="{{ url('/expert/application/edit/stage4/delete/'.$eq->id) }}" class="btn btn-danger btn-xs">Delete</a>
                                    </div>
                                </td>
                            </tr>
                            @php $sno++; @endphp
