        ...
        <div class="row">
            ...
            <div class="col-sm-6 well well-sm white-background minus15px-margin-top">
                <form class="form-horizontal" role="form" method="POST"
                      action="{{url('/expert/application/edit/checklogin/')}}" autocomplete="off" accept-charset="UTF-8"
                    ...
                    <div class="form-group {{ $errors->has('dob') ? 'has-error' : '' }}">
                        <label for="dob" class="control-label col-sm-4">
                            <div class="left-text">
                                <div class="blue-text">Date of Birth (DoB) (DD/MM/YYYY)</div>
                            </div>
                        </label>
                        <div class="col-sm-6">
