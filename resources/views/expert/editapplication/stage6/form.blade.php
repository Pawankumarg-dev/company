        ...
        <div class="row">
            <div class="col-sm-12 well well-sm white-background minus15px-margin-top">
                <form class="form-horizontal" role="form" method="POST"
                      action="{{url('/expert/application/edit/stage6/updateform')}}" autocomplete="off" accept-charset="UTF-8"
                    ...
                    <input type="hidden" name="expertteachingexperience_id" value="{{ $expertteachingexperience->id }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" id="application_no" name="application_no" value="{{ $expertteachingexperience->expert->application_no }}" readonly/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" id="name" name="name" value="{{  $expertteachingexperience->expert->title }} {{  $expertteachingexperience->expert->name }}" readonly/>
                        </div>
                    </div>
                    ...
                    <div class="form-group {{ $errors->has('designation') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="designation" name="designation" placeholder="Enter Designation" value="{{ $expertteachingexperience->designation }}"/>
                            <script>
                                $(document).ready(function () {
                    ...
                    <div class="form-group {{ $errors->has('department') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="department" name="department" placeholder="Enter Department" value="{{ $expertteachingexperience->department }}"/>
                            <script>
                                $(document).ready(function () {
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <select class="form-control" name="organization_category">
                                        ...
                                        <option value="Government Organization" @if($expertteachingexperience->organization_category == "Government Organization") selected @endif>Government Organization</option>
                                        <option value="Aided Organization" @if($expertteachingexperience->organization_category == "Aided Organization") selected @endif>Aided OrganizationOrganization</option>
                                        <option value="Non-Government Organization" @if($expertteachingexperience->organization_category == "Non-Government Organization") selected @endif>Non-Government Organization</option>
                                        <option value="Private Organization" @if($expertteachingexperience->organization_category == "Private Organization") selected @endif>Private Organization</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <select class="form-control" name="organization_type">
                                        <option value="0">-- Select --</option>>
                                        <option value="School" @if($expertteachingexperience->organization_type == "School") selected @endif>School</option>
                                        <option value="College" @if($expertteachingexperience->organization_type == "College") selected @endif>College</option>
                                        <option value="National Institute" @if($expertteachingexperience->organization_type == "National Institute") selected @endif>National Institute</option>
                                        <option value="University" @if($expertteachingexperience->organization_type == "University") selected @endif>University</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group {{ $errors->has('organization_name') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="organization_name" name="organization_name" placeholder="Enter Organization Name" value="{{ $expertteachingexperience->organization_name }}"/>
                            <script>
                                $(document).ready(function () {
                    ...
                    <div class="form-group {{ $errors->has('organization_address') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" rows="5" id="organization_address" name="organization_address" placeholder="Enter Organization's Full Address" >{{ $expertteachingexperience->organization_address }}</textarea>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <select class="form-control" name="state_id">
                                        ...
                                        @foreach($states as $s)
                                            <option value="{{ $s->id }}" @if($expertteachingexperience->state_id == $s->id) selected @endif>{{ $s->state_name }} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="form-group {{ $errors->has('from_date') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-3">
                            <div class='input-group date' id='fromdate_datetimepicker'>
                                <input type='text' class="form-control" placeholder="Choose From Date" id="from_date" name="from_date"  value="{{ $expertteachingexperience->from_date }}"/>
                        ...
                        <div class="form-group {{ $errors->has('to_date') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-3">
                                <div class='input-group date' id='todate_datetimepicker'>
                                    <input type='text' class="form-control" placeholder="Choose To Date" id="to_date" name="to_date"  value="{{ $expertteachingexperience->to_date }}"/>
                                    <div class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </div>
                                    <script type="text/javascript">
