                    ...
                    <table class="table table-bordered table-condensed table-responsive">
                        <tr>
                            <th class="grey-background" colspan="10">
                                ...
                                <div class="right-text">
                                    <a href="{{ url('/expert/application/edit/stage7/addform/'.$expert->id) }}" class="btn btn-success btn-sm">Add Qualification</a>
                                </div>
                            </th>
                        </tr>
                        <tr class="grey-background">
                        ...
                        @foreach($expert->expertnonteachingexperiences as $ete)
                            <tr>
                                ...
                                <td class="left-text">
                                    <b>{{ $ete->organization_category }}</b></b>
                                </td>
                                ...
                                <td class="center-text blue-text">
                                    <div class="center-text">
                                        <a href="{{ url('/expert/application/edit/stage7/form/'.$ete->id) }}" class="btn btn-info btn-xs">Edit</a>
                                        <a href="{{ url('/expert/application/edit/stage7/delete/'.$ete->id) }}" class="btn btn-danger btn-xs">Delete</a>
                                    </div>
                                </td>
                            </tr>
