        ...
        <tr>
            <td style="padding:10px 40px ;font-size:12px;">
                ...
                <table border="1" cellpadding="1" cellspacing="0" width="100%" style="border:1px solid #aaa;margin-top:10px;">
                            ...
                            <th class="center-text " style="display: none;">Photo-Copying</th>
                            <th> Amount</th>
                            </tr>
                            ...
                            <td class="center-text">
                            <?php 
                                $fee1 = $reevaluationfee->reevaluation_fee;
                                if($reevaluationapplication->id < 1569){
                                    $fee1 = 2000;
                                }
                                $fee = ($subject->reevaluation_applystatus * $fee1 ) + ($subject->retotalling_applystatus * $reevaluationfee->retotalling_fee) + ($subject->photocopying_applystatus * $reevaluationfee->photocopying_fee)
                            ?>
                            ₹ {{number_format($fee,0)}}
                            </td>
                            </tr>
                        ...
                        <table border="0" cellpadding="5" cellspacing="0" width="100%" >
                            <tr>
                                <td width="90%">
                                    Date: {{ $reevaluationapplication->order->payment_date->format('d.m.Y')}}
                                </td>
                                <td class="center-text">
                                <img src="{{url('files/signs/')}}/{{$candidate->approvedprogramme->programme->nber_id}}_d.png" style="height:40px;"><br>
                                    Director:
                                </td>
                            </tr>
                        </table>
