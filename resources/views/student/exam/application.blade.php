...
@section('content')
 ...
 <ul>
                            ...
                            @endif
                    <a href="{{ url('student/exam/applications?view=resubmit') }}"   class="btn btn-danger hidden">Modify Exam Application</a>
                    <br />
                    <br />
                    @endif
...
@endif 
                        ...
                        <div id="amount" class="alert alert-warning">
                                ...
                                <div class="print-container">
                                    <table width="100%"  border="1" cellpadding="10" cellspacing="5">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$applicant->order->order_number ?? '-'}} ({{$applicant->order->bank_referencenumber ?? '-'}})</td>
                                        </tr>
                                        {{-- <tr>
