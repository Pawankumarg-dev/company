                    ...
                    <table class="table table-condensed table-bordered" role="table">
                        <tr>
                            <th class="center-text" colspan="6">
                                <h4 class="text-primary">Institute - Centre Information Update Notifications</h4>
                            </th>
                        </tr>
                        ...
                        @foreach($institutes as $institute)
                            <tr>
                                ...
                                <td><span class="text-info">{{ $institute->name }}</span></td>
                                <td class="center-text">
                                ...
                                <td class="center-text">
                                    ...
                                    @else
                                        <a href="{{ url('/nber/notifications/institute-information/show-institute/'.$institute->id) }}" class="btn btn-sm btn-primary">
