                ...
                if (rows.length === 0) {
                    ...
                    if (accessOn.length) {
                        ...
                        accessOn.forEach(function(d){
                            ...
                            html += '<tr><th>MAC/OS</th><td>' + (d.public_ip || '-') + '</td></tr>';
                    ...
                    var nonAccessRows = rows.filter(function(d){ return parseInt(d.access) !== 1; });
                    if (nonAccessRows.length === 0) {
                        html += '<p class="text-info">No non-access records found.</p>';
                    } else {
                        ...
                        nonAccessRows.forEach(function(d, idx){
                            html += '<tr>';
                            html += '<td>' + (idx+1) + '</td>';
