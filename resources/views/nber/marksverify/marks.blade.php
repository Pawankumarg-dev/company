    ...
    @foreach($collections as $c)
        <tr>
            ...
            <td>
                ...
                @if(!empty($c->mark))
                    <input id='IN_{{$c->candidate->id}}_{{$c->subject->id}}'  value="{{$c->mark->internal}}"   inex="IN" cid="{{$c->candidate->id}}" sid="{{$c->subject->id}}"  disabled="true" min="{{$c->subject->imin_marks}}" max="{{$c->subject->imax_marks}}"  aid="{{$c->id}}"  @if( $c->mark->internal < $c->subject->imin_marks && $c->mark->internal != NULL) class="mark disabled fail" @else class="mark disabled pass" @endif />
                @else
                    <input id='IN_{{$c->candidate->id}}_{{$c->subject->id}}'  class="mark disabled" inex="IN" cid="{{$c->candidate->id}}" sid="{{$c->subject->id}}" disabled="true"  min="{{$c->subject->imin_marks}}" max="{{$c->subject->imax_marks}}" aid="{{$c->id}}" />
                @endif
            ...
            <td>
                ...
                @if(!empty($c->mark))
                    <input id='EX_{{$c->candidate->id}}_{{$c->subject->id}}'  value="{{$c->mark->external}}"   inex="EX" cid="{{$c->candidate->id}}" sid="{{$c->subject->id}}" @if($c->subject->subjecttype->type=='Practical') disabled=='true' class="mark disabled" @else  @if( $c->mark->external < $c->subject->emin_marks  ) class="mark  fail" @else class="mark  pass" @endif @endif    min="{{$c->subject->emin_marks}}" max="{{$c->subject->emax_marks}}"  aid="{{$c->id}}"  />
                @else
                    <input id='EX_{{$c->candidate->id}}_{{$c->subject->id}}'   inex="EX" cid="{{$c->candidate->id}}" sid="{{$c->subject->id}}"  @if($c->subject->subjecttype->type=='Practical') disabled=='true'  class="mark disabled " @else class="mark" @endif    min="{{$c->subject->emin_marks}}" max="{{$c->subject->emax_marks}}"  aid="{{$c->id}}" />
                @endif
                <span class="small">{{$c->subject->emax_marks}} </span>
                @if($c->subject->subjecttype->type=='Theory')
            ...
            <td>
                ...
                $total = $c->mark->internal + $c->mark->external + $c->mark->grace ;
