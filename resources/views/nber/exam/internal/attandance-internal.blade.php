                        ...
                        <tbody>
                            @foreach ($programmes as $program)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ url('/nber/verify/attendance') }}" method="POST">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="course_id" value="{{ $program->programme_id }}">
                                            <input type="hidden" name="institute_id" value="{{ $institute_id }}">
                                            <input type="hidden" name="academic_year" value="{{ $program->academic_id }}">
