                    ...
                    @foreach($applications as $candidate)
                        <tr>
                            ...
                            <td>
                                ...
                                <input class="attn"  data-id="{{$candidate->id}}"  type="radio" name="attendence_{{$candidate->id}}" value="1" @if($candidate->externalattendance_id == 1) selected @endif  /> Present 
                                <input  class="attn" data-id="{{$candidate->id}}" type="radio" name="attendence_{{$candidate->id}}" value="2"  @if($candidate->externalattendance_id == 2) selected @endif />  Absent 
                            </td>
                                <td>
                                    <input type="number" id="internal_{{$candidate->id}}" name="internal_{{$candidate->id}}" min="0"  max="{{$subject->imax_marks}}" value="{{$candidate->internal_mark}}"> 
                                </td>
                                <td>
                                    <input type="number" id="external_{{$candidate->id}}" name="external_{{$candidate->id}}" min="0"  max="{{$subject->emax_marks}}"  value="{{$candidate->external_mark}}"> 
                                </td>
                        </tr>
                    @endforeach
                </table>
