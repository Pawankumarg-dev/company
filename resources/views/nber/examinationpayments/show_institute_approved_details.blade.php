                    ...
                    <div class="panel-body">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <p>Verification Status: <b> (Total: {{ $examinationpayments->count() }})</b></p>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group form-inline right-text">
                                            <label for="sel1">Change Institutes:</label>
                                            <select class="form-control" id="changeOptions">
                                                @foreach($institutes as $institute_list)
                                                    <option value="{{ $institute_list->id }}" @if($institute_list->id == $institute->id) selected @endif value="{{ url('nber/examinationpayments/showverificationstatus/institute/'.$exam->id.'/'.$institute_list->id) }}">{{ $institute_list->code }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-warning">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            {{ $institute->code }} - Verification Pending
                                        </div>
                                    </div>
