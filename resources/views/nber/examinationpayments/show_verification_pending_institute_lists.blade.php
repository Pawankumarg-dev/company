                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="panel panel-warning">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            Institutes - Verification Pending ({{ $institutes->count() }})
                                        </div>
                                    </div>
                                                            ...
                                                            @foreach($institutes as $institute)
                                                                <tr>
                                                                    ...
                                                                    <td class="center-text">
                                                                        <a href="{{ url('/nber/examinationpayments/showverificationpending/institute/'.$exam->id.'/'.$institute->id) }}" class="btn btn-primary btn-sm">
