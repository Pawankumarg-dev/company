                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    Course Verification Status - <b>{{ $academicyear->year }}</b> Academic year (Total: <b>{{ $totalCount }}</b>)
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <ul class="breadcrumb col-sm-12">
                                            ...
                                            <li>Course Verification Status - <b>{{ $academicyear->year }}</b> Academic year</li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="center-text">
                                                                <a href="{{ url('/nber/enrolments/showapprovedprogrammeslist/'.$academicyear->id.'/6') }}" class="btn btn-sm btn-info">
                                                                    view details
                                                                </a>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="panel panel-warning">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="center-text">
                                                                <a href="{{ url('/nber/enrolments/showapprovedprogrammeslist/'.$academicyear->id.'/1') }}" class="btn btn-sm btn-info">
                                                                    view details
                                                                </a>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="panel panel-success">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="center-text">
                                                                <a href="{{ url('/nber/enrolments/showapprovedprogrammeslist/'.$academicyear->id.'/2') }}" class="btn btn-sm btn-info">
                                                                    view details
                                                                </a>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="panel panel-danger">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="center-text">
                                                                <a href="{{ url('/nber/enrolments/showapprovedprogrammeslist/'.$academicyear->id.'/3') }}" class="btn btn-sm btn-info">
                                                                    view details
                                                                </a>
                                                            </div>
                                                        </div>
                                            ...
                                            <table class="table table-condensed table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center-text">
                                                        <a href="{{ url('/nber/enrolments/showapprovedprogrammeslist/'.$academicyear->id.'/6') }}" class="btn btn-xs btn-info">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center-text">
                                                        <a href="{{ url('/nber/enrolments/showapprovedprogrammeslist/'.$academicyear->id.'/1') }}" class="btn btn-xs btn-info">
                                                            <span class="glyphicon glyphicon-eye-open"></span>
                                                        </a>
                                                    </td>
                                                    <td class="center-text">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center-text">
                                                        <a href="{{ url('/nber/enrolments/showapprovedprogrammeslist/'.$academicyear->id.'/2') }}" class="btn btn-xs btn-info">
                                                            <span class="glyphicon glyphicon-eye-open"></span>
                                                        </a>
                                                    </td>
                                                    <td class="center-text">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center-text">
                                                        <a href="{{ url('/nber/enrolments/showapprovedprogrammeslist/'.$academicyear->id.'/3') }}" class="btn btn-xs btn-info">
                                                            <span class="glyphicon glyphicon-eye-open"></span>
                                                        </a>
                                                    </td>
                                                    <td class="center-text">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center-text">
                                                        <a href="{{ url('/nber/enrolments/showapprovedprogrammeslist/'.$academicyear->id.'/4') }}" class="btn btn-xs btn-info">
                                                            <span class="glyphicon glyphicon-eye-open"></span>
                                                        </a>
                                                    </td>
                                                    <td class="center-text">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="right-text">
                                            Last updated: {{ date('d-m-Y') }} ({{ date('h:i:s A') }})
                                        </div>
                                    </div>
                                </div>
                            </div>
