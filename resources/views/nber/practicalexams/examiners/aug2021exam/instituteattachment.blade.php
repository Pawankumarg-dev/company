...
<div class="container">
    ...
    <hr>
    <div class="row">
        <div class="col-sm-6"><div class="pull-left">NIEPMD/NBER/RCI/Exam/2021-22/</div></div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="justified-text">
               NIEPMD-NBER has appointed the external practical examiners for the RCI Diploma / Certificte courses for External Practical Examination - August 2021. The details are as follows:
            </div>
            <br>
            <table class="table table-bordered table-condensed" width="100%">
                <tr>
                    <td class="bold-text center-text" width="20%">Name of the External Examiner</td>
