                    ...
                    <table class="table table-condensed table-bordered table-hover" role="table">
                        ...
                        @foreach($subjects as $s)
                            <tr>
                                ...
                                <td class="center-text blue-text">{{ $s->syear }}</td>
                                <td class="center-text blue-text" >{{ $s->scode }}</td>
                                <td class="left-text blue-text">{{ $s->sname }}</td>
                                <td class="center-text">
                                    <a href="{{ url('/nber/exams/practical/'.$exam->id.'/downloadattendancesheet/'.$approvedprogramme->id.'/'.$s->id) }}" class="btn btn-primary btn-sm" target="_blank">
