                    ...
                    @foreach($approvedprogramme->candidates->sortBy('enrolmentno') as $candidate)
                        <tr>
                            ...
                            <td >
                                ...
                                <a target="_blank" href="{{url('nber/candidate/')}}/{{$candidate->id}}">{{ $candidate->name }}</a>
                            ...
                            <td>
                                ...
                                <a href="{{url('/nber/examapplications/')}}/{{$approvedprogramme->id}}/22/{{$candidate->id}}" class="btn btn-primary btn-sm" target="_blank">
