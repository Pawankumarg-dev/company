...
<div class="container">
    ...
    <hr>
    <div class="row">
        <div class="col-sm-6 h7-text"><div class="pull-left bold-text">NIEPMD/NBER-RCI/ March / EXAM-CLO</div></div>
    ...
    <div class="row">
        <div class="col-sm-12 h7-text">
            To<br>
            <b>{{ $clo->title->title }} {{ $clo->name }}</b><br>
            Mobile No.: <b>{{ $clo->contactnumber1 }} @if(!is_null($clo->contactnumber2))/ {{ $clo->contactnumber2 }}@endif</b><br>
            Email: <b>{{ $clo->email1 }} @if(!is_null($clo->email2))/ {{ $clo->email2 }}@endif</b>
        </div>
    </div>
    <br>
    <div class="row">
        <div class="col-sm-12 h7-text">
            <table class="table table-borderless table-condensed">
                <tr>
                    ...
                    <td class="justified-text">
                        Appointment of Central Level Observer (CLO) for March 2021 Examinations
            ...
            <div class="col-sm-12">
                ...
                <div class="justified-text">
                    ...
                    Consequent upon expression of your interest; NIEPMD - NBER is pleased to appoint you as the Central Level Observer in the following examination centre:
                </div>
                <br>
                <table border="2" class="table table-bordered table-condensed" width="100%">
                    ...
                    <tr>
                        <td class="text-center">{{ $clo->externalexamcenter->code }}</td>
                        <td class="text-center">
                            {{ $clo->externalexamcenter->name }}<br>
                            {{ $clo->externalexamcenter->address }}
                            @if($clo->externalexamcenter->district != ''), {{ $clo->externalexamcenter->district }} @endif
                            @if($clo->externalexamcenter->state != ''), {{ $clo->externalexamcenter->state }} @endif
                            @if($clo->externalexamcenter->pincode != '')- {{ $clo->externalexamcenter->pincode }} @endif<br>
                            Contact No.: {{ $clo->externalexamcenter->contactnumber1 }} @if($clo->externalexamcenter->contactnumber2 != '')/ {{ $clo->externalexamcenter->contactnumber2 }} @endif<br>
                            Email: {{ $clo->externalexamcenter->email1 }}@if($clo->externalexamcenter->email2 != '')/ {{ $clo->externalexamcenter->email2 }} @endif
        ...
        <div class="row">
            <div class="col-sm-12 h7-text">
                ...
                <i>NOTE: CLO honorarium will be settled by NIEPMD NBER</i>
            </div>
        </div>
    </div>
</div>
