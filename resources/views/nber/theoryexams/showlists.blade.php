        ...
        <div class="row">
            <div class="col-sm-12 well well-sm white-background minus15px-margin-top">
                <div class="center-text bold-text">
                    {{ $exam->name }} @if($exam->examtype_id == '2') Supplementary @endif - Theory Examination Applied Count<br>
                    Attendance Sheet
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            <th colspan="8">
                                <div class="right-text">
                                    <a href="{{ url('/nber/exams/theory/'.$exam->id.'/showlistsexcel') }}" class="btn btn-success">
