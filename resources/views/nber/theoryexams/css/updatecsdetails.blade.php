@extends('layouts.app')
@section('content')
    <form class="form-horizontal" action="{{ url('/nber/theoryexams/cs/updatecsdetails') }}" method="POST"
                                    ...
                                    <div class="col-sm-12">
                                        <section class="hidethis">
                                            <ul class="breadcrumb">
                                                ...
                                                <li class="active">Update CS details</li>
                                            </ul>
                                        </section>
                                    </div>
                                </div>
                                            ...
                                            <div class="panel panel-info">
                                                ...
                                                <div class="panel-body">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <select class="form-control blue-text" name="nodalofficer_id" id="nodalofficer_id">
                                                                ...
                                                                @foreach($nodalofficers as $nodalofficer)
                                                                    <option value="{{ $nodalofficer->id }}" @if($nodalofficer->id == $cs->nodalofficer_id) selected @endif>{{ $nodalofficer->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-2">
                                                            <select class="form-control blue-text" name="externalexamcenter_id" id="externalexamcenter_id">
                                                                ...
                                                                @foreach($externalexamcenters as $externalexamcenter)
                                                                    <option value="{{ $externalexamcenter->id }}" @if($externalexamcenter->id == $cs->externalexamcenter_id) selected @endif>{{ $externalexamcenter->code }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-2">
                                                            <select class="form-control blue-text" name="title_id" id="title_id">
                                                                ...
                                                                @foreach($titles as $title)
                                                                    <option value="{{ $title->id }}" @if($title->id == $cs->title_id) selected @endif>{{ $title->title }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <input type="text" class="form-control blue-text" name="code" id="code" value="{{ $cs->code }}"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control blue-text" name="password" id="password" value="{{ $cs->password }}"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <select class="form-control blue-text" name="type" id="type">
                                                                ...
                                                                <option value="Centre Superintendent" @if($cs->type == "Centre Superintendent") selected @endif>Centre Superintendent</option>
                                                                <option value="Exam Centre Incharge" @if($cs->type == "Exam Centre Incharge") selected @endif>Exam Centre Incharge</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control blue-text" name="name" id="name" value="{{ $cs->name }}"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control blue-text" name="contactnumber1" id="contactnumber1" value="{{ $cs->contactnumber1 }}"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control blue-text" name="contactnumber2" id="contactnumber2" value="{{ $cs->contactnumber2 }}"/>
                                                            (optional)
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control blue-text" name="email1" id="email1" value="{{ $cs->email1 }}"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control blue-text" name="email2" id="email2" value="{{ $cs->email2 }}"/>
                                                            (optional)
                                                        </div>
                                                    </div>
    ...
    <script>
        ...
        function validateForm() {
            ...
            if(!$('#name').val()) {
                swal("Error Occurred!!!", "Please enter the cs name", "error");
                return false;
            }
            else {
