...
@section('fields')
	...
	{!! Form::bsText('abbreviation','Abbreviation') !!}
...
@section('table')
	...
	@foreach($collections as $c)
		<tr>
			...
			<td> 
        		<a href="{{url('nber/subjects')}}/{{$c->id}}" class="btn btn-xs btn-info" > Subjects </a> 
        	...
        	{{-- {!! Form::tbEdit($link,$c) !!} --}}
			<td>
				<a href="{{url('nber/admissions')}}?course_id={{$c->course_id}}" class="btn btn-xs btn-primary">Institutes</a>
			</td>
		</tr>
    @endforeach
@endsection
...
@section('editscript')
	...
	{!! Form::tbEditscript('abbreviation',$link,'input') !!}
