            ...
            <div class="col-md-6" style="height: 600px;">
                ...
                @if (isset($Internalmarksheet) && $Internalmarksheet->filename)
                    <button class="btn btn-sm btn-info"
                        onclick="window.open('{{ url('/files/internalmarksheets/' . $Internalmarksheet->filename) }}', '_blank')">
                        Open PDF Full View
                    </button>
                    <iframe src="{{ url('/files/internalmarksheets/' . $Internalmarksheet->filename) }}"
                        style="width: 100%; height: 100%; border: 1px solid #ccc;" frameborder="0" scrolling="auto">
                    </iframe>
                @else
