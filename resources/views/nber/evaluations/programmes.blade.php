                                                                                ...
                                                                                @if ($peogram > 0)
                                                                                    @foreach (\App\Subject::where('programme_id', $data->id)->where('subjecttype_id', 1)->get() as $subject_data)
                                                                                        ...
                                                                                        @if ($applications_count > 0)
                                                                                            <form
                                                                                                action="{{ url('/') }}/verify-external"
                                                                                                method="post">
                                                                                                {{ csrf_field() }}
                                                                                                <input type="hidden"
                                                                                                    name="subject_id"
                                                                                                    value="{{ $subject_data->id }}">
                                                                                                <input type="hidden"
                                                                                                    name="program_id"
                                                                                                    value="{{ $data->id }}">
                                                                                                <input type="hidden"
                                                                                                    name="evaluationcenter_id"
                                                                                                    value="{{ $evaluationcenter->id }}">
                                                                                                <input type="hidden"
                                                                                                    name="externalexamcenter_id"
                                                                                                    value="{{ $examcenter->externalexamcenter->id }}">

                                                                                                <button
                                                                                                    class="btn btn-warning">{{ $subject_data->scode }}</button>
