    ...
    <div class="panel-body">
        <form class="form-horizontal" action="{{ url(route('create.staff.profile')) }}" method="POST" onsubmit="return validateForm()" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" autocomplete="off"  onpaste="return false;" name="email_address" id="email-address" class="form-control blue-text" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="password" autocomplete="off" name="password" onpaste="return false;" id="password" class="form-control blue-text" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" id="confirm-password"  onpaste="return false;"  autocomplete="off" class="form-control blue-text" />
                </div>
            </div>
