    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-header" style="margin-top:0;">
                <span>CLO Daily  Report</span>
                <a class="btn btn-sm btn-success pull-right" href="{{ url('/nber/clo') }}">Back</a>
            </h3>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 " style="margin-left:15px; margin-bottom:10px;">
                <div>
                <strong>CLO NAME : </strong>  {{$clo->name}}
                </div>
            </div>
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        @if(count($results) > 0)
                            ...
                            @foreach($results as $index => $cloreport)
