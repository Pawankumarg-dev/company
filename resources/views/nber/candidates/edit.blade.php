...
@section('style')
	...
	<script>
		$(document).ready(function () {
			getDistricts();
			loadPDistricts(0);
			$('#enrolmentno').attr('autofocus',true);
...
<form action="{{url('nber/candidate/update'.'/'.$candidate->id)}}" enctype="multipart/form-data" method="post">
			...
			<div class="row">
				<div class="col-md-12">
					<ul class="breadcrumb" >
						...
						<li><a href="{{url('/nber/candidates/'.$apid)}}"> {{$programme->course_name}}  ({{Session::get('academicyear')}}) </a></li>
						<li> Edit Candidate Enrolment Data</li>
						<button type="submit" class="btn btn-primary pull-right btn-bc">Save</button>
						{{-- <button type="submit" class="btn btn-secondary pull-right btn-bc" style="margin-right:10px;" formaction="{{url('/nber/candidate/update/draft')}}/{{$candidate->id}}" >Save as Draft</button> --}}
				...
				<div class="panel panel-default">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body personal">
							...
							{{-- @if($candidate->enable_name_edit == 0)'readonly'@endif --}}
						...
						<!--	@if($programme->programmegroup->id != '3')
							...
							<div class="form-group">
								...
								{{-- <input type="text" id="dob" name="dob"  class="form-control" value="{{$candidate->dob}}" > --}}
								<input type="date" id="dob" name="dob" @if($candidate->enable_dob_change != 1 )  @endif class="form-control" value="{{\Carbon\Carbon::parse($candidate->dob)->format('Y-m-d')}}" >
							</div>
						...
						<div class="panel-body">
							<table class="table table-bordered">
								...
								<tr>
									...
									@if($candidate->educations->where('edugrade','10th')->count()>0)
										<?php $exists = 1; ?>
									@else
										<?php $exists = 0 ; ?>
									@endif
									<td>
										<input type="text" class="form-control" id="board_1" name="board_1"  value="@if($exists==1){{$candidate->educations->where('edugrade','10th')->first()->board}}@else''@endif" />
									</td>
									<td  style="width:80px;">
										<input type="text"  class="form-control year" id="yop_1" name="yop_1" value="@if($exists==1){{$candidate->educations->where('edugrade','10th')->first()->yop}}@else''@endif" />
									</td>
									<td>
										<input type="text" class="form-control num year" id="tmarks_1" name="tmarks_1" value="@if($exists==1){{$candidate->educations->where('edugrade','10th')->first()->tmarks}}@else''@endif" />
									</td>
									<td>
										<input type="text" class="form-control num year" id="omarks_1" onkeyup="javascript:calper(1);" name="omarks_1"  value="@if($exists==1){{$candidate->educations->where('edugrade','10th')->first()->omarks}}@else''@endif"  >
									</td>
									<td>
										<input type="text" class="form-control" id="percentage_1" name="percentage_1"  value="@if($exists==1){{$candidate->educations->where('edugrade','10th')->first()->percentage}}@else''@endif"   >
									</td>
									<td>
										<input type="text" class="form-control" id="subjects_1" name="subjects_1"  value="@if($exists==1){{$candidate->educations->where('edugrade','10th')->first()->subjects}}@else''@endif" >
									</td>
								</tr>
								@endif
								...
								<td>
									...
									<td>
										<input type="text" class="form-control" id="board_2" name="board_2"  value="@if($candidate->educations->count() > 1){{$candidate->educations->where('edugrade','12th')->first()->board}}@endif"  >
									</td>
									<td  style="width:80px;">
										<input type="text"  class="form-control year" id="yop_2" name="yop_2"  value="@if($candidate->educations->count() > 1){{$candidate->educations->where('edugrade','12th')->first()->yop}}@endif" />
									</td>
									<td>
										<input type="text" class="form-control num" id="tmarks_2" name="tmarks_2"  value="@if($candidate->educations->count() > 1){{$candidate->educations->where('edugrade','12th')->first()->tmarks}}@endif"  >
									</td>
									<td>
										<input type="text" class="form-control num" id="omarks_2" onkeyup="javascript:calper(2);" name="omarks_2"  value="@if($candidate->educations->count() > 1){{$candidate->educations->where('edugrade','12th')->first()->omarks}}@endif"  >
									</td>
									<td>
										<input type="text" class="form-control" id="percentage_2" name="percentage_2"  value="@if($candidate->educations->count() > 1){{$candidate->educations->where('edugrade','12th')->first()->percentage}}@endif"  >
									</td>
									<td>
										<input type="text" class="form-control" id="subjects_2" name="subjects_2"  value="@if($candidate->educations->count() > 1){{$candidate->educations->where('edugrade','12th')->first()->subjects}}@endif" >
									</td>
								</tr>
								@endif {{--
