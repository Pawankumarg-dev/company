...
@section('content')
	...
	<form action="{{url('/nber/candidate')}}" enctype="multipart/form-data" method="post" id="form">
		{!! csrf_field() !!}
		<div class="container" >
			<div class="row">
				<div class="col-md-12">
					<ul class="breadcrumb" >
						...
						<!-- <button type="submit" class="btn btn-secondary pull-right btn-bc" style="margin-right:10px;" formaction="{{url('/nber/candidate/draft')}}"" >Save as Draft</button> -->
					</ul>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body personal">
							...
							{{ Form::bsText('enrolmentno',"Enrolment Number*",'',['class' => 'form-control']) }}
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<h4>Documents</h4>
							{{ Form::bsFile('photo',"Photo *",'image',null,null,'/nber/fileupload') }}
							<small>
