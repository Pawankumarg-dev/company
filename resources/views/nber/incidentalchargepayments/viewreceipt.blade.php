        ...
        <tr>
            <td>
                ...
                <table border="0" cellpadding="5" cellspacing="0" width="100%">
                    <tr>
                        <td colspan="2" class="center-text bold-text">
                            INCIDENTAL CHARGE PAYMENT - ACKNOWLEDGEMENT RECEIPT
                        </td>
                    </tr>
                    <tr>
                ...
                <table border="0" cellpadding="5" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td>Course and Terms</td>
                        <td class="bold-text">: {{ $incidentalpayments->count() }} (list attached)</td>
                    </tr>
                    <tr>
                        <td>Amount Paid</td>
                ...
                <table border="0" cellpadding="5" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td colspan="2">
                            <b>{{ $institute->code }}</b> is remitted Rs. <b>{{ $common->amount_paid }}</b> /-
                            (<b>@php echo no_to_words($common->amount_paid) @endphp</b> only) towards the payment of Incidental Charges
    ...
    <table border="1" cellpadding="5" cellspacing="0" width="100%">
        ...
        <tr>
            <th colspan="8" class="center-text">
                ...
                <hr />
                INCIDENTAL CHARGE PAYMENT<br>(Payment Reference No. {{ $common->reference_number }})
            </th>
        </tr>
        <tr>
            <th>S.<br>No.</th>
        ...
        @foreach($incidentalpayments as $ip)
            <tr>
                ...
                <td class="center-text">{{ $ip->incidentalfee->academicyear->year }}</td>
                <td>{{ $ip->incidentalfee->programme->course_name }}</td>
                <td>{{ $ip->incidentalfee->programme->name }}</td>
                <td class="center-text">{{ $ip->incidentalfee->term }}</td>
            </tr>
            @php $sno++; @endphp
        @endforeach
        </tbody>
