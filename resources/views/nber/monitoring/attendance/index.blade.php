...
<div class="container">
	<div class="row">
		<div class="col-12">
            <h3>Jan 2025  EXAMINATION - EVALUATION - ANSWEBOOKLET SCANNING & EVALUATION
            </h3>
                ...
                @foreach($approvedprogrammes  as $ap)
                        <tr>
                            ...
                            <td style="">
                                 ...
                                 <?php $apdata = \App\Approvedprogramme::find($ap->approvedprogramme_id); ?>


                                {{$apdata->academicyear->year}}
                            </td>
                            <td>
                            ...
                            >
                                <a href="{{url('/nber/verifyattendance')}}/{{$ap->approvedprogramme_id}}?subject_id={{$ap->subject_id}}&examschedule_id={{$ap->examschedule_id}}" class="btn @if(($ap->attendance == 0)) btn-danger @else btn-success @endif--}} btn-sm">Attendance</a>
                            </td>
                            <td
