...
<div class="page-break">
    ...
    <div id="border">
        <img src="{{url('files/border.png')}}" height="100%" width="100%" />
    </div>
    <center>
    <img src="{{asset('/images')}}/nber_logo.png"  style="width: 120px; height: 120px !important" class="img" /> <br>
    ...
    <table style="width:100%">
        <tr>
            <td style="font-size:12px;">
                Serial No. :
                <?php $aslno = str_pad($candidate->currentapplicant->reevaluation_slno_certificate,5,'0',STR_PAD_LEFT) ?>                                   
            ...
            <td style="text-align:right;">
                <img src="{{asset('/files/enrolment/photos')}}/{{$candidate->photo}}"  style="width: 90px;max-height:120px;" class="img" />
            </td>
        </tr>
    </table>
        ...
        @if($candidate->gender_id == 1)S/o @else D/o @endif
         Shri.  <b>{{strtoupper($candidate->fathername)}}</b>
          ...
          {{$candidate->approvedprogramme->programme->name}}
           ...
           conducted by the National Board of Examination in Rehabilitation - {{$candidate->approvedprogramme->programme->nber->name_code}} in<?php $percentage = $candidate->currentapplicant->reevaluation_result_percentage; ?>
           <b>
           @if($percentage > 74.99  )
    ...
    <p>
        <table style="width:100%">
            ...
            <td style="height:72.5px;width:80.5px;">
                ...
                <img src="{{asset('/files')}}/rci-seal.png" style="width: 70px; height: 70px !important"   class="img" />
                </td>
                <td style="text-align:center;width:220px;">
                
                    <img src="{{asset('/files/signs/')}}/msnew.png" style="height:60px;">
                    <br>
                    Secretary - NBER
                    <br>
