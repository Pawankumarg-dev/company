...
<html>
<head>
    <title>{{$applicant->candidate->enrolmentno}} - {{$applicant->candidate->name}} - Term {{$term}}</title>
    <style>
        @media print {
            #printPageButton {
                display: none;
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td  width="15%" style="text-align:right;">
                            <img src="{{asset('/images/')}}/{{$nber->logo}}"  style="height: 70px;max-width:100px;" class="img" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td>
                <table border="1" cellpadding="2" cellspacing="0" width="100%" class="h8-text border-table" style="margin-top:15px;">
                    <tr>
                        <td class="h7-text center-text blue-text" colspan="5" style="border-left:1px solid #aaa;border-top:1px solid #aaa;"><span class="h7-text bold-text bt">PRACTICAL HALL TICKET :  MAY-JUNE 2025</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="left-text blue-text" width="15%">Study Center 
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="left-text blue-text bold-text" width="25%" colspan="2" >
                                <?php 
                                    $eec = null;
                                    $ecs = \App\Examcenter::where('institute_id',1057)->where('exam_id',27)->get();
                                    
                                    foreach($ecs as $ec){
                                        if($ec->externalexamcenter->district == $applicant->candidate->district_id){
                            ...
                            <div class="left-text blue-text">
                                <ol>
                                    <li class="custom-li-style bold-text">
                                        ...
                                        Certificates. If correction(s) needed, report immediately to {{$nber->short_name_code}}-NBER through your study centre before the declaration of results.
                                        <span class="h8-text">
