    ...
    <table style="width:100%">
        <tr>
            <td style="font-size:12px;">
                Serial No. :
                <?php $aslno = str_pad($candidate->supplimentaryresults()->first()->slno_certificate,5,'0',STR_PAD_LEFT) ?>                                   
        ...
        @if($candidate->gender_id == 1)S/o @else D/o @endif
         Shri.  <b>{{strtoupper($candidate->fathername)}}</b>
          ...
          {{$candidate->approvedprogramme->programme->name}}
           ...
           conducted by the National Board of Examination in Rehabilitation - {{$candidate->approvedprogramme->programme->nber->name_code}} in<?php $percentage = $candidate->supplimentaryresults()->first()->final_percentage; ?>
           <b>
           @if($percentage > 74.99  )
        ...
        <table style="width:100%">
            ...
            <td style="height:72.5px;width:80.5px;">
                ...
                <td style="text-align:center;width:220px;">
                    ...
                    Secretary - NBER
                    <br>
                    Date: {{\Carbon\Carbon::parse($candidate->supplimentaryresults()->first()->certificate_date)->format('d-m-Y')}}
                </td>
            </tr>
        </table>
