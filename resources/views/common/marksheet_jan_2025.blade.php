        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="h7-text">
                        ...
                        <tr>
                            ...
                            <td class="left-text blue-text" style="padding-bottom:2px;"> : 
                            @if($term==1)
                                    <?php $aslo = str_pad($result_data->marksheet_sl_no_first_year,5,'0',STR_PAD_LEFT); ?>
                                @else
                                    <?php $aslo = str_pad($result_data->marksheet_sl_no_second_year,5,'0',STR_PAD_LEFT); ?>
                                @endif
            ...
            <tr>
                <td style="padding-top:5px;">
                            ...
                            @foreach($applications->sortBy('subject.sortorder') as $application)
                                ...
                                @if($subject->subjecttype_id==1 )
                                    <tr>
                                        ...
                                        @else
                                        <?php 
                                            $stotal = $application->mark_in + $application->mark_ex + $application->grace; 
                                            $subjectresult = 'Pass';
                                            if($application->mark_in < $subject->imin_marks && $subject->is_internal == 1){
                                                $result = 'Fail';
                                                $subjectresult = 'Fail';
                                            }
                                            if(($application->mark_ex + $application->grace) < $subject->emin_marks && $subject->is_external == 1 && $subjectresult != 'Fail'){
                                                $result = 'Fail';
                                                $subjectresult = 'Fail';
                                            }
                                        ?>
                                    ...
                                    <tr>
                                        ...
                                        @if($subject->is_internal == 0)
                                            ...
                                            <?php 
                                                $stotal = $application->mark_ex; 
                                                $subjectresult = 'Pass';
                                                if($application->mark_ex < $subject->emin_marks){
                                                    $result = 'Fail';
                                                    $subjectresult = 'Fail';
                                                }
                                            ?>
                        ...
                        <tr>
                            <td colspan="9">
                                ...
                                ?>
                                        ...
                                        <?php if($term==1)    {
                                            $total = $result_data->first_year_total;
                                        }else{
                                            $total = $result_data->second_year_total;
                                        }
                    ...
                    <?php 
                        if($term==1){
                            $r = $result_data->first_year_result;
                        }else{
                            $r = $result_data->second_year_result;
                        }
                        if($r==1){
                            $result = 'Pass';
                        }else{
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="h7-text fixed-bottom">
            ...
            <tr>
                ...
                Result Declared: 
                    ...
                    {{\Carbon\Carbon::parse($result_data->marksheetissuded_date)->format('d-m-Y')}}
                </td>
            </tr>
        </table>
    </div>
