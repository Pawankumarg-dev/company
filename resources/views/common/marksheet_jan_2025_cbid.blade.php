                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td colspan="3" class="center-text" >
                                <img src="/var/www/html/rcinber/public/images/rcilogo.png"  style="height: 80px !important" class="img" /> &nbsp;&nbsp;
                                <img src="/var/www/html/rcinber/public/images/mu.png"  style="width: 80px; height: 80px !important" class="img" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="h8-text center-text" width="70%" style="vertical-align: top;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="h7-text">
                        ...
                        <tr>
                            ...
                            @if($term==1)
                                ...
                                @else
                                    <?php $aslo = str_pad($candidate->allresults()->first()->marksheet_sl_no_second_year,5,'0',STR_PAD_LEFT); ?>
                                @endif
            ...
            <tr>
                <td style="padding-top:5px;">
                    ...
                    <table border="1" cellpadding="0" cellspacing="0" width="100%" class="h7-text">
                        ...
                        @php
                            $hastheory = \App\Allapplication::where('candidate_id',$candidate->id)->whereHas('subject',function($q) use($term){
                                $q->where('syear',$term);
                                $q->where('subjecttype_id',1);
                            })->count();
                            
                            $haspractical = \App\Allapplication::where('candidate_id',$candidate->id)->whereHas('subject',function($q) use($term){
                                $q->where('syear',$term);
                            ...
                            @foreach($applications->sortBy('subject.sortorder') as $application)
                                ...
                                @if($subject->subjecttype_id==2 )
                                    <tr>
                                        ...
                                        @endif
                                        @if($application->attendance_in == 2)
                                            <?php   $subjectresult = 'Absent'; ?>
                                        @endif
                                        <td class="center-text blue-text small-text">
                                            {{$subjectresult}}
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                ?>
                                        ...
                                        <?php if($term==1)    {
                                            $total = $candidate->allresults()->first()->first_year_total;
                                        }else{
                                            $total = $candidate->allresults()->first()->second_year_total;
                                        }
                    ...
                    <?php 
                        if($term==1){
                            ...
                            $r = $candidate->allresults()->first()->second_year_result;
                        }
                        if($r==1){
                            $result = 'Pass';
                        }else{
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="h7-text fixed-bottom">
            ...
            <tr>
                ...
                Result Declared: 
                    ...
                    {{\Carbon\Carbon::parse($candidate->allresults()->first()->marksheetissuded_date)->format('d-m-Y')}}
                </td>
            </tr>
        </table>
    </div>
