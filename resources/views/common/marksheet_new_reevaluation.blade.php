                ...
                <td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="h7-text">
                        ...
                        <tr>
                            ...
                            <td class="left-text blue-text" style="padding-bottom:2px;"> : 
                            @if($term==1)
                                    <?php $aslo = str_pad($candidate->newresultreevaluations()->first()->marksheet_sl_no_first_year,5,'0',STR_PAD_LEFT); ?>
                                @else
                                    <?php $aslo = str_pad($candidate->newresultreevaluations()->first()->marksheet_sl_no_second_year,5,'0',STR_PAD_LEFT); ?>
                                @endif
            ...
            <tr>
                <td style="padding-top:5px;">
                    ...
                    <table border="1" cellpadding="0" cellspacing="0" width="100%" class="h7-text">
                        ...
                        @php
                            $hastheory = \App\Newapplication::where('candidate_id',$candidate->id)->whereHas('subject',function($q) use($term){
                                $q->where('syear',$term);
                                $q->where('subjecttype_id',1);
                            })->count();
                            
                            $haspractical = \App\Newapplication::where('candidate_id',$candidate->id)->whereHas('subject',function($q) use($term){
                                $q->where('syear',$term);
                        ...
                        @if($hastheory > 0)
                            ...
                            @foreach($applications->sortBy('subject.sortorder') as $application)
                                @php 
                                    ...
                                    if(!is_null($application->alternative_paper)){
                                ...
                                @if($subject->subjecttype_id==1 )
                                    <tr>
                                        ...
                                        @if($subject->is_internal == 0)
                                            ...
                                            <?php 
                                                $stotal = $application->final_external; 
                                                $subjectresult = 'Pass';
                                                if(($application->final_external ) < $subject->emin_marks){
                                                    $result = 'Fail';
                                                    $subjectresult = 'Fail';
                                                }
                                            ?>
                                        ...
                                        @else
                                        <?php 
                                            $stotal = $application->internal_mark + $application->final_external ; 
                                            $subjectresult = 'Pass';
                        ...
                        @if($haspractical>0)
                            @php $sno = '1'; @endphp
                            <tr>
                                <td class="blue-text bold-text" width="100%" colspan="12">  &nbsp;&nbsp;Practical</td>
                            </tr>
                            @foreach($applications->sortBy('subject.sortorder') as $application)
                                @php 
                                    $subject = $application->subject;
                        ...
                        <tr>
                            <td colspan="9">
                                ...
                                ?>
                                        ...
                                        <?php if($term==1)    {
                                            $total = $candidate->newresultreevaluations()->first()->first_year_total;
                                        }else{
                                            $total = $candidate->newresultreevaluations()->first()->second_year_total;
                                        }
                    ...
                    <?php 
                        if($term==1){
                            $r = $candidate->newresultreevaluations()->first()->first_year_result;
                        }else{
                            $r = $candidate->newresultreevaluations()->first()->second_year_result;
                        }
                        if($r==1){
                            $result = 'Pass';
                        }else{
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="h7-text fixed-bottom">
            ...
            <tr>
                ...
                Result Declared: 
                    ...
                    {{\Carbon\Carbon::parse($candidate->newresultreevaluations()->first()->marksheetissuded_date)->format('d-m-Y')}}
                </td>
            </tr>
        </table>
    </div>
