            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td style="padding-top:5px;">
                                ...
                                @if($subject->subjecttype_id==1 )
                                    <tr>
                                        ...
                                        @if($subject->is_internal == 0)
                                            ...
                                            <?php 
                                                $stotal = $application->external_mark + $application->grace; 
                            ...
                            <tr>
                                <td colspan="9">
                                    ...
                                    ?>
                                            ...
                                            <?php if($term==1)    {
                                                $total = $candidate->currentapplicant->first_year_total;
                                            }else{
                                                $total = $candidate->currentapplicant->second_year_total;
                                            }
                        ...
                        <?php 
                            if($term==1){
                                $r = $candidate->currentapplicant->term_one_result_id;
                            }else{
                                $r = $candidate->currentapplicant->term_two_result_id;
                            }
                            if($r==1){
                                $result = 'Pass';
                            }else{
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="h7-text fixed-bottom">
                        ...
                        <tr>
                            ...
                            Issued Date: 
                             ...
                             {{\Carbon\Carbon::parse($candidate->currentapplicant->marksheetissuded_date)->format('d-m-Y')}}
                            </td>
                        </tr>
                        </table>
        </div>
