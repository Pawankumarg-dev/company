            ...
            <tr>
                <td style="padding-top:5px;">
                    ...
                    <table border="1" cellpadding="0" cellspacing="0" width="100%" class="h7-text">
                        ...
                        @php
                            $hastheory = \App\Newapplication::where('candidate_id',$cid)->whereHas('subject',function($q) use($term){
                                $q->where('syear',$term);
                                $q->where('subjecttype_id',1);
                            })->count();
                            
                            $haspractical = \App\Newapplication::where('candidate_id',$cid)->whereHas('subject',function($q) use($term){
                                $q->where('syear',$term);
