        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="h7-text">
                        ...
                        <tr>
                            ...
                            <td class="left-text blue-text" style="padding-bottom:2px;"> : 
                            @if($term==1)
                                    <?php $aslo = str_pad($candidate->supplimentaryresults()->first()->marksheet_sl_no_first_year,5,'0',STR_PAD_LEFT); ?>
                                @else
                                    <?php $aslo = str_pad($candidate->supplimentaryresults()->first()->marksheet_sl_no_second_year,5,'0',STR_PAD_LEFT); ?>
                                @endif
            ...
            <tr>
                <td style="padding-top:5px;">
                        ...
                        <tr>
                            <td colspan="9">
                                ...
                                ?>
                                        ...
                                        <?php if($term==1)    {
                                            $total = $candidate->supplimentaryresults()->first()->first_year_total;
                                        }else{
                                            $total = $candidate->supplimentaryresults()->first()->second_year_total;
                                        }
                    ...
                    <?php 
                        if($term==1){
                            $r = $candidate->supplimentaryresults()->first()->first_year_result;
                        }else{
                            $r = $candidate->supplimentaryresults()->first()->second_year_result;
                        }
                        if($r==1){
                            $result = 'Pass';
                        }else{
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="h7-text fixed-bottom">
            ...
            <tr>
                ...
                Result Declared: 
                    ...
                    {{\Carbon\Carbon::parse($candidate->supplimentaryresults()->first()->marksheetissuded_date)->format('d-m-Y')}}
                </td>
            </tr>
        </table>
    </div>
