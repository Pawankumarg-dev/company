        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="h7-text">
                        ...
                        <tr>
                            ...
                            <td class="left-text blue-text" style="padding-bottom:2px;"> : 
                            @if($term==1)
                                    <?php $aslo = str_pad($candidate->newresults()->first()->marksheet_sl_no_first_year,5,'0',STR_PAD_LEFT); ?>
                                @else
                                    <?php $aslo = str_pad($candidate->newresults()->first()->marksheet_sl_no_second_year,5,'0',STR_PAD_LEFT); ?>
                                @endif
            ...
            <tr>
                <td style="padding-top:5px;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="center-text blue-text  small-text">
                                            @if($application->externalattendance_id == 1)
                                                {{$application->external_mark + $application->grace}}
                                            @endif
                                        ...
                                        @if($subject->is_internal == 0)
                                            ...
                                            <?php 
                                                ...
                                                $subjectresult = 'Pass';
                                                if(($application->external_mark + $application->grace) < $subject->emin_marks){
                                                    $result = 'Fail';
                                                    $subjectresult = 'Fail';
                                                }
                                            ?>
                                        ...
                                        @else
                                        <?php 
                                            $stotal = $application->internal_mark + $application->external_mark + $application->grace; 
                                            $subjectresult = 'Pass';
                        ...
                        <tr>
                            <td colspan="9">
                                ...
                                ?>
                                        ...
                                        <?php if($term==1)    {
                                            $total = $candidate->newresults()->first()->first_year_total;
                                        }else{
                                            $total = $candidate->newresults()->first()->second_year_total;
                                        }
                    ...
                    <?php 
                        if($term==1){
                            $r = $candidate->newresults()->first()->first_year_result;
                        }else{
                            $r = $candidate->newresults()->first()->second_year_result;
                        }
                        if($r==1){
                            $result = 'Pass';
                        }else{
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="h7-text fixed-bottom">
            ...
            <tr>
                ...
                Result Declared: 
                    ...
                    {{\Carbon\Carbon::parse($candidate->newresults()->first()->marksheetissuded_date)->format('d-m-Y')}}
                </td>
            </tr>
        </table>
    </div>
