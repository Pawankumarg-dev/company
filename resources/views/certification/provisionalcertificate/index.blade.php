            ...
            <div class="col-sm-12">
                <div class="center-text">
                    <div class="text-primary">
                        ...
                        <span class="h5-text">Provisional Certificate Page</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <div class="panel-title">
                            Student - Provisional Certificate Page
                        </div>
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{url('/online-provisional-certificate/')}}">
