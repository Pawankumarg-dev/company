        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    <li><a href="{{ url('/practicalexam/home') }}">Home </a></li>
                    <li><a class="" href="{{ url('/faculty/tabill') }}">TABill </a></li>
                    <li><a class="" href="{{ url('/appointment') }}">Appointment Letters</a></li>
                    ...
                    @else
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                <i class="fa fa-btn fa-user"></i>   {{ Session::get('username') }} <span class="caret"></span>
                            </a>
