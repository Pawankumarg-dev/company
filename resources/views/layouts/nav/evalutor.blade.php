        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                    <?php 
                        $name = \App\Evaluator::where('user_id',Auth::user()->id)->first()->name;
                        ?>
                    {{ $name }}
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    <li class=""><a href="{{ url('/evaluationcenter') }}"> Home </a></li>
                    <li class="hidden"><a href="{{ url('/evaluationcenter/progress') }}"> Progress </a></li>
                    <li><a class="hidden" href="{{ url('/reeevaluation') }}"> Revaluation </a></li>
