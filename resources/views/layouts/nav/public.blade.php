        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                           Grievances <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu" role="menu">
                              <li><a href="{{ url('grievances') }}">Submit Grievances</a></li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                        <li><a href="{{ url('/logon#institute') }}" class="login" style="background-color:green;">Institute Login</a></li>
                        <li><a href="{{ url('/logon#student') }}" class="login" style="background-color:orange;">Student Login</a></li>
                        <li><a href="{{ url('/logon#examcenter') }}" class="login hidden" style="background-color:rgb(0, 26, 255);">Exam Center Login</a></li>
                        <li><a href="{{ url('/logon#pe') }}" class="login hidden" style="background-color:#659969;">Practical Examiner Login</a></li>
