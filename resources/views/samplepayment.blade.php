...
<body>
<form method="POST" name="customerData" action="{{ url('/testRequestHandler') }}">
    ...
    <table width="50%" height="100" border='1' align="center">
        ...
        <tr>
            <td>TID	:</td><td><input autocomplete="off" type="text" name="tid" id="tid" readonly /></td>
        </tr>
        <tr>
            <td>Merchant Id	:</td><td><input autocomplete="off" type="text" name="merchant_id" value="692568"/></td>
        </tr>
        <tr>
            <td>Order Id	:</td><td><input autocomplete="off" type="text" name="order_id" value="123654789"/></td>
        </tr>
        <tr>
            <td>Amount	:</td><td><input autocomplete="off" type="text" name="amount" value="10.00"/></td>
        </tr>
        <tr>
            <td>Currency	:</td><td><input autocomplete="off" type="text" name="currency" value="INR"/></td>
        </tr>
        <tr>
            <td>Redirect URL	:</td><td><input autocomplete="off" type="text" name="redirect_url" value="http://localhost/ccavResponseHandler.php"/></td>
        </tr>
        <tr>
            <td>Cancel URL	:</td><td><input autocomplete="off" type="text" name="cancel_url" value="http://localhost/ccavResponseHandler.php"/></td>
        </tr>
        <tr>
            <td>Language	:</td><td><input autocomplete="off" type="text" name="language" value="EN"/></td>
        </tr>
        <tr>
            <td colspan="2">Billing information(optional):</td>
        </tr>
        <tr>
            <td>Billing Name	:</td><td><input autocomplete="off" type="text" name="billing_name" value="Charli"/></td>
        </tr>
        <tr>
            <td>Billing Address	:</td><td><input autocomplete="off" type="text" name="billing_address" value="Room no 1101, near Railway station Ambad"/></td>
        </tr>
        <tr>
            <td>Billing City	:</td><td><input autocomplete="off" type="text" name="billing_city" value="Indore"/></td>
        </tr>
        <tr>
            <td>Billing State	:</td><td><input autocomplete="off" type="text" name="billing_state" value="MH"/></td>
        </tr>
        <tr>
            <td>Billing Zip	:</td><td><input autocomplete="off" type="text" name="billing_zip" value="425001"/></td>
        </tr>
        <tr>
            <td>Billing Country	:</td><td><input autocomplete="off" type="text" name="billing_country" value="India"/></td>
        </tr>
        <tr>
            <td>Billing Tel	:</td><td><input autocomplete="off" type="text" name="billing_tel" value="9999999999"/></td>
        </tr>
        <tr>
            <td>Billing Email	:</td><td><input autocomplete="off" type="text" name="billing_email" value="test@test.com"/></td>
        </tr>
        <tr>
            <td colspan="2">Shipping information(optional)</td>
        </tr>
        <tr>
            <td>Shipping Name	:</td><td><input autocomplete="off" type="text" name="delivery_name" value="Chaplin"/></td>
        </tr>
        <tr>
            <td>Shipping Address	:</td><td><input autocomplete="off" type="text" name="delivery_address" value="room no.701 near bus stand"/></td>
        </tr>
        <tr>
            <td>shipping City	:</td><td><input autocomplete="off" type="text" name="delivery_city" value="Hyderabad"/></td>
        </tr>
        <tr>
            <td>shipping State	:</td><td><input autocomplete="off" type="text" name="delivery_state" value="Andhra"/></td>
        </tr>
        <tr>
            <td>shipping Zip	:</td><td><input autocomplete="off" type="text" name="delivery_zip" value="425001"/></td>
        </tr>
        <tr>
            <td>shipping Country	:</td><td><input autocomplete="off" type="text" name="delivery_country" value="India"/></td>
        </tr>
        <tr>
            <td>Shipping Tel	:</td><td><input autocomplete="off" type="text" name="delivery_tel" value="5555555555"/></td>
        </tr>
        <tr>
            <td>Merchant Param1	:</td><td><input autocomplete="off" type="text" name="merchant_param1" value="additional Info."/></td>
        </tr>
        <tr>
            <td>Merchant Param2	:</td><td><input autocomplete="off" type="text" name="merchant_param2" value="additional Info."/></td>
        </tr>
        <tr>
            <td>Merchant Param3	:</td><td><input autocomplete="off" type="text" name="merchant_param3" value="additional Info."/></td>
        </tr>
        <tr>
            <td>Merchant Param4	:</td><td><input autocomplete="off" type="text" name="merchant_param4" value="additional Info."/></td>
        </tr>
        <tr>
            <td>Merchant Param5	:</td><td><input autocomplete="off" type="text" name="merchant_param5" value="additional Info."/></td>
        </tr>
        ...
        <tr> <td> Payment Option: </td>
            <td>
                <input autocomplete="off" class="payOption" type="radio" name="payment_option" value="OPTCRDC">Credit Card
                <input autocomplete="off" class="payOption" type="radio" name="payment_option" value="OPTDBCRD">Debit Card  <br/>
                <input autocomplete="off" class="payOption" type="radio" name="payment_option" value="OPTNBK">Net Banking
                <input autocomplete="off" class="payOption" type="radio" name="payment_option" value="OPTCASHC">Cash Card <br/>
                <input autocomplete="off" class="payOption" type="radio" name="payment_option" value="OPTMOBP">Mobile Payments
                <input autocomplete="off" class="payOption" type="radio" name="payment_option" value="OPTEMI">EMI
                <input autocomplete="off" class="payOption" type="radio" name="payment_option" value="OPTWLT">Wallet
            </td>
        </tr>
                ...
                <div id="emi_div" style="display: none">
                    <table border="1" width="100%">
                        ...
                        <tr> <td> Emi plan id: </td>
                            <td><input autocomplete="off" readonly="readonly" type="text" id="emi_plan_id"  name="emi_plan_id" value=""/> </td>
                        </tr>
                        <tr> <td> Emi tenure id: </td>
                            <td><input autocomplete="off" readonly="readonly" type="text" id="emi_tenure_id" name="emi_tenure_id" value=""/>  </td>
                        </tr>
        ...
        <tr> <td> Card Type: </td>
            <td><input autocomplete="off" type="text" id="card_type" name="card_type" value="" readonly="readonly"/></td>
        </tr>
        ...
        <tr> <td> Data Accepted At </td>
            <td><input autocomplete="off" type="text" id="data_accept" name="data_accept" readonly="readonly"/></td>
        </tr>

        <tr> <td> Card Number: </td>
            <td> <input autocomplete="off" type="text" id="card_number" name="card_number" value=""/>e.g. 4111111111111111 </td>
        </tr>
        <tr> <td> Expiry Month: </td>
            <td> <input autocomplete="off" type="text" name="expiry_month" value=""/>e.g. 07 </td>
        </tr>
        <tr> <td> Expiry Year: </td>
            <td> <input autocomplete="off" type="text" name="expiry_year" value=""/>e.g. 2027</td>
        </tr>
        <tr> <td> CVV Number:</td>
            <td> <input autocomplete="off" type="text" name="cvv_number" value=""/>e.g. 328</td>
        </tr>
        <tr> <td> Issuing Bank:</td>
            <td><input autocomplete="off" type="text" name="issuing_bank" value=""/>e.g. State Bank Of India</td>
        </tr>
        <tr>
            <td> Mobile Number:</td>
            <td><input autocomplete="off" type="text" name="mobile_number" value=""/>e.g. 9770707070</td>
        </tr>
        <tr>
            <td> MMID:</td>
            <td><input autocomplete="off" type="text" name="mm_id" value=""/>e.g. 1234567</td>
        </tr>
        <tr>
            <td> OTP:</td>
            <td><input autocomplete="off" type="text" name="otp" value=""/>e.g. 123456</td>
        </tr>
        <tr>
            <td> Promotions:</td>
                    ...
                    if(value.payOpt=="OPTEMI"){
                        ...
                        $.each(emiPlansArray, function() {
                            emiPlanTr=emiPlanTr+
                                ...
                                "<td> <input autocomplete="off" type='radio' name='emi_plan_radio' id='"+this['tenureMonths']+"' value='"+this['tenureId']+"' class='emi_plan_radio' > </td>"+
