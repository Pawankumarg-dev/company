...
@section('content')
    ...
    <form class="form-horizontal" role="form" method="POST"
          action="{{url('/externalexamcenter/markabsentees')}}" autocomplete="off" accept-charset="UTF-8"
          >
        {{ csrf_field() }}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="radio" name="ext_attendance[{{ $count }}]" id="ext_attendance2_{{ $count }}" onclick="displayAbsent({{ $count }})"
                                                                   ...
                                                                   @if(is_null($mark)) @elseif($mark->external == 'Abs') checked @else @endif
                                                            />
                                                        </td>
                                                        <td>
                                                        <span id="remarkcolumn_{{ $count }}"
                                                              @if(is_null($mark))
                                                                class="bold-text h5-text"
                                                              @elseif($mark->external == 'Abs')
                                                              class="bold-text red-text h5-text"
                                                              @else
                                                              class="bold-text h5-text"
                                                              @endif
                                                        >
