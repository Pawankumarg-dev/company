...
@section('content')
    <input type="hidden" id="externalexamcode" value="{{ $externalexamcenter->code }}"/>
                        ...
                        <tr style="font-size: large">
                            ...
                            <td>
                                <div id="div12" style="display: none">
                                    <a href="{{ url('/externalexamcenter/subject1/') }}"
                                       target="_blank"
                        ...
                        <tr style="font-size: large">
                            ...
                            <td>
                                <div id="div22" style="display: none">
                                    <a href="{{ url('/externalexamcenter/subject2/') }}"
                                       target="_blank"
                                       class="btn btn-success"
                                       onclick="getinfo2()"
                                    >
                        ...
                        <tr style="font-size: large">
                            ...
                            <td>
                                <div id="div32" style="display: none">
                                    <a href="{{ url('/externalexamcenter/subject3/') }}"
                                       target="_blank"
                                       class="btn btn-success"
                                       onclick="getinfo3()"
                                    >
