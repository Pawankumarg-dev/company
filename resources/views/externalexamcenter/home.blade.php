                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <h3>
                                            <a href="{{ url('/externalexamcenter/questionpaper/showlist/'.$exam->id.'/'.$externalexamcenter->id) }}">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <h3>
                                            <a href="{{ url('/externalexamcenter/'.$externalexamcenter->id.'/show-demo-question-papers/'.$exam->id) }}">
