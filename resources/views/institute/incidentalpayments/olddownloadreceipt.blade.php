            ...
            <td>
                ...
                <table border="0" cellpadding="5" cellspacing="0" width="100%">
                    <tr>
                        ...
                        AFFILIATION FEE PAYMENT - ACKNOWLEDGEMENT RECEIPT
                        </td>
                    </tr>
                    <tr>
                ...
                <table border="0" cellpadding="5" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            (<b>@php echo no_to_words($common->amount_paid) @endphp</b> only) towards the payment of Affiliation fee
    ...
    <table border="1" cellpadding="5" cellspacing="0" width="100%">
        ...
        <tr>
            <th colspan="8" class="center-text">
                ...
                <hr />
                    AFFILIATION FEE  PAYMENT<br>(Payment Reference No. {{ $common->reference_number }})
            </th>
        </tr>
        <tr>
            <th>S.<br>No.</th>
