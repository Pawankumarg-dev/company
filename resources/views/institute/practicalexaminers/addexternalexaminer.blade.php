                                ...
                                <div class="col-sm-12">
                                    <section class="hidethis">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active">External Examiner Details</li>
                                        </ul>
                                    </section>
                                </div>
                            </div>

                            <form method="post" action="{{ url('/institute/examinations/practicalexaminers/updateexternalexaminer/') }}" onsubmit="return validateForm()">
                                {!! csrf_field() !!}
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" role="table">
                                                        ...
                                                        <tr>
                                                            <th width="10%">Age</th>
                                                            <th width="90%">
                                                                <input id="age" name="age" type="text" size="3" placeholder="" required /> years
                                                            </th>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <th width="10%">Rehabilitation Qualifications</th>
                                                            <th width="90%">
