...
@section('style')
	...
	<script>
		...
		//	$('#nationality_id').val(86).change();
			...
			$('input[name="enrolmentno"]').attr('readonly',true);
			...
			<div class="row">
				<div class="col-md-12">
					<ul class="breadcrumb" >
						...
						<li>{{$programme->course_name}}  ({{Session::get('academicyear') }}) </li>
						<li> Edit Candidate Enrolment Data</li>
			...
			<div class="row">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						{{ Form::bsTextarea('comment',"Reason to edit the data *",'Update the missing data') }}	
					</div>
				</div>
					<div class="panel panel-default">
						<div class="panel-heading">
						...
						<div class="panel-body personal">
							...
							{{ Form::bsText('enrolmentno',"Enrolment Number*",$candidate->enrolmentno,['class' => 'form-control']) }}
							...
							-->
							{{ Form::bsText('mothername',"Mother's name *",$candidate->mothername,['class' => 'form-control max99']) }}
						<!--	@if($programme->programmegroup->id != '3')
							...
							@endif -->
							@if($candidate->gender_id < 1)
							{{ Form::bsRadio('gender_id',$genders,'gender','Gender *',null,$candidate->gender_id) }}
							@else
							{{ Form::bsRadio('gender_id',$genders,'gender','Gender *',null,$candidate->gender_id) }}
							@endif
							{{ Form::bsRadio('isdisabled',$yesno,'value','PwD *',null,$candidate->isdisabled) }}
							...
							{{ Form::bsRadio('ews',$yesno,'value',"Do you belong to EWS category? *",null,$candidate->ews) }}
							{{ Form::bsEmail('email',"Email ID *",$candidate->email) }}
							{{ Form::bsText('contactnumber',"Mobile Number *",$candidate->contactnumber,['class'=>'form-control max10']) }}
						</div>
					</div>
				</div>
				...
				<div class="col-md-6">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							{{ Form::bsText('address',"Addresss *",$candidate->address) }}
							{{ Form::bsSelect('state_id',$states,'state_name','State *',null,$candidate->state_id)}}
				...
				<div class="col-md-6">
					<div class="panel panel-default">
						...
						<div class="panel-body per-add">
							{{ Form::bsText('paddress',"Addresss *",$candidate->paddress,['class'=>'form-control saa']) }}
							{{ Form::bsSelect('pstate_id',$states,'state_name','State *',null,$candidate->pstate_id)}}
							...
							{{ Form::bsText('ppincode',"PIN Code *",$candidate->ppincode,['class'=>'form-control saa']) }}
						</div>
					</div>
				</div>
				<div class="col-md-12">
						...
						<div class="panel-body">
							<table class="table table-bordered">
								...
								<tr>
									...
									<td>
										<input type="text" class="form-control" id="board_1" name="board_1" value="@if(\App\Education::where('candidate_id',$candidate->id)->where('edugrade','10th')->count() > 0){{\App\Education::where('candidate_id',$candidate->id)->where('edugrade','10th')->firstOrFail()->board}}@endif" />
									</td>
									<td  style="width:80px;">
										<input type="text"  class="form-control year" id="yop_1" name="yop_1" value="@if(\App\Education::where('candidate_id',$candidate->id)->where('edugrade','10th')->count() > 0){{\App\Education::where('candidate_id',$candidate->id)->where('edugrade','10th')->firstOrFail()->yop}}@endif" />
									</td>
									<td>
										<input type="text" class="form-control num year" id="tmarks_1" name="tmarks_1" value="@if(\App\Education::where('candidate_id',$candidate->id)->where('edugrade','10th')->count() > 0){{\App\Education::where('candidate_id',$candidate->id)->where('edugrade','10th')->firstOrFail()->tmarks}}@endif" />
									</td>
									<td>
										<input type="text" class="form-control num year" id="omarks_1" onkeyup="javascript:calper(1);" name="omarks_1"  value="@if(\App\Education::where('candidate_id',$candidate->id)->where('edugrade','10th')->count() > 0){{\App\Education::where('candidate_id',$candidate->id)->where('edugrade','10th')->firstOrFail()->omarks}}@endif"  >
									</td>
									<td>
										<input type="text" class="form-control" id="percentage_1" name="percentage_1"  value="@if(\App\Education::where('candidate_id',$candidate->id)->where('edugrade','10th')->count() > 0){{\App\Education::where('candidate_id',$candidate->id)->where('edugrade','10th')->firstOrFail()->percentage}}@endif"   >
									</td>
									<td>
										<input type="text" class="form-control" id="subjects_1" name="subjects_1"  value="@if(\App\Education::where('candidate_id',$candidate->id)->where('edugrade','10th')->count() > 0){{\App\Education::where('candidate_id',$candidate->id)->where('edugrade','10th')->firstOrFail()->subjects}}@endif	" >
									</td>
								</tr>
								@endif
								...
								<td>
									...
									<td>
										<input type="text" class="form-control" id="board_2" name="board_2"  value="@if(\App\Education::where('candidate_id',$candidate->id)->count() > 0){{\App\Education::where('candidate_id',$candidate->id)->where('edugrade','12th')->firstOrFail()->board}}@endif"  >
									</td>
									<td  style="width:80px;">
										<input type="text"  class="form-control year" id="yop_2" name="yop_2"  value="@if(\App\Education::where('candidate_id',$candidate->id)->count() > 0){{\App\Education::where('candidate_id',$candidate->id)->where('edugrade','12th')->firstOrFail()->yop}}@endif" />
									</td>
									<td>
										<input type="text" class="form-control num" id="tmarks_2" name="tmarks_2"  value="@if(\App\Education::where('candidate_id',$candidate->id)->count() > 0){{\App\Education::where('candidate_id',$candidate->id)->where('edugrade','12th')->firstOrFail()->tmarks}}@endif"  >
									</td>
									<td>
										<input type="text" class="form-control num" id="omarks_2" onkeyup="javascript:calper(2);" name="omarks_2"  value="@if(\App\Education::where('candidate_id',$candidate->id)->count() > 0){{\App\Education::where('candidate_id',$candidate->id)->where('edugrade','12th')->firstOrFail()->omarks}}@endif"  >
									</td>
									<td>
										<input type="text" class="form-control" id="percentage_2" name="percentage_2"  value="@if(\App\Education::where('candidate_id',$candidate->id)->count() > 0){{\App\Education::where('candidate_id',$candidate->id)->where('edugrade','12th')->firstOrFail()->percentage}}@endif"  >
									</td>
									<td>
										<input type="text" class="form-control" id="subjects_2" name="subjects_2"  value="@if(\App\Education::where('candidate_id',$candidate->id)->count() > 0){{\App\Education::where('candidate_id',$candidate->id)->where('edugrade','12th')->firstOrFail()->subjects}}@endif" >
									</td>
								</tr>
								@endif {{--
								<tr>
									...
									<td>
										<input type="text" class="form-control" id="board_3" name="board_3"  value="@if($candidate->eductions->count() > 2){{\App\Education::where('candidate_id',$candidate->id)->whereNotIn('edugrade',['10th','12th'])->firstOrFail()->board}}@endif"  >
									</td>
									<td  style="width:80px;">
										<input type="text"  class="form-control year" id="yop_3" name="yop_3"  value="@if($candidate->eductions->count() > 2){{\App\Education::where('candidate_id',$candidate->id)->whereNotIn('edugrade',['10th','12th'])->firstOrFail()->yop}}@endif"  />
									</td>
									<td>
										<input type="text" class="form-control num" id="tmarks_3" name="tmarks_3"  value="@if($candidate->eductions->count() > 2){{\App\Education::where('candidate_id',$candidate->id)->whereNotIn('edugrade',['10th','12th'])->firstOrFail()->tmarks}}@endif" >
									</td>
									<td>
										<input type="text" class="form-control num" id="omarks_3" onkeyup="javascript:calper(3);" name="omarks_3"  value="@if($candidate->eductions->count() > 2){{\App\Education::where('candidate_id',$candidate->id)->whereNotIn('edugrade',['10th','12th'])->firstOrFail()->omarks}}@endif" >
									</td>
									<td>
										<input type="text" class="form-control" id="percentage_3" name="percentage_3"  value="@if($candidate->eductions->count() > 2){{\App\Education::where('candidate_id',$candidate->id)->whereNotIn('edugrade',['10th','12th'])->firstOrFail()->percentage}}@endif"   >
									</td>
									<td>
										<input type="text" class="form-control" id="subjects_3" name="subjects_3"  value="@if($candidate->eductions->count() > 2){{\App\Education::where('candidate_id',$candidate->id)->whereNotIn('edugrade',['10th','12th'])->firstOrFail()->subjects}}@endif" >
									</td>
								</tr>
							--}}
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<h4>Documents </h4>
							{{ Form::bsFile3('photo',"Photo *",'image',$candidate->photo,'files/enrolment/photos') }}
							<small>
								Only jpeg, jpg, and png image with maximum size 200KB and photo image widdth and height les than 800px allowed. 
							</small>
							<!--@if($programme->programmegroup->id != '3')
								{{ Form::bsFile3('doc_dob',"SSLC / 12th Certificate as proof of date of birth") }}
								{{ Form::bsFile3('doc_mark',"SSLC / 12th Marksheet") }}
							@else
								{{ Form::bsFile3('doc_rci',"RCI - CRR Certificate") }}
							...
							?>
							{{--{{ Form::bsFile3('doc_dob',$desc . " Certificate *") }} --}}
							{{ Form::bsFile3('doc_tenth', "10th Marksheet *",null,$candidate->doc_tenth,'files/enrolment/marksheets/tenth') }}

							<small>Only PDF file with size 200KB to 2048 KB allowed</small>
							@if($programme->programmegroup->twelveth == 1)
							{{ Form::bsFile3('doc_twelveth', "12th Marksheet *",null,$candidate->doc_twelveth,'files/enrolment/marksheets/twelveth') }}
							<small>Only PDF file with size 200KB to 2048 KB allowed</small>

							@endif
							{{ Form::bsFile3('doc_application', "Upload the scanned copy of the application form submitted by the student *",null,$candidate->doc_application,'files/enrolment/applications') }}
							<div id="doc_community_form" class="hidden">
							{{ Form::bsFile3('doc_community',"Proof of SC/ST or OBC Certificate as prescribed in Central Government format",null,$candidate->doc_community,'files/enrolment/c') }}
							</div>
							<!--{{ Form::bsFile3('doc_disability',"Disability Certificate, if the candidate has a disability") }}
							{{ Form::bsFile3('doc_percentage_exception',"supporting State Norms G.O.s / Circulars for Percentage exception") }}
							-->
							<hr />
						...
						//	$('#pvillagediv').addClass('hidden');
							...
							data.forEach(function (value,key) {
								if(id!=0){
									...
									@if($candidate->pdistrict_id > 0)
									if(value.id=={{$candidate->pdistrict_id}}){
										$('#pdistrict_id').append('<option selected value="'+value.id+'">'+ value.districtName  +'</option>');
	...
	//		formData.append('dob','1955-01-01');
				...
				$.ajax({
					...
					success: function (data) {
						...
						//	$('#villagediv').addClass('hidden');
							...
							@if($candidate->district_id > 0)
								if(value.id=={{$candidate->district_id}}){
					...
					//		$('#villagediv').removeClass('hidden');
							...
							//	$('#subdistrict_id').attr('disabled',false);
								data['subdistricts'].forEach(function (value,key) {
									@if($candidate->subdistrict_id>0)
										if(value.id=={{$candidate->subdistrict_id}}){
							...
							//	$('#village_id').attr('disabled',false);
								data['blocks'].forEach(function (value,key) {
									@if($candidate->village_id>0)
									if(value.id=={{$candidate->village_id}}){
							...
							if(data['subdistricts'].length == 0){
								...
								data['subdistricts'].forEach(function (value,key) {
									if(tid!=0){
										...
										@if($candidate->psubdistrict_id > 0)
										if(value.id=={{$candidate->psubdistrict_id}}){
											$('#psubdistrict_id').append('<option selected value="'+value.id+'">'+ value.Sub_district_Name  +'</option>');
										}else{
											$('#psubdistrict_id').append('<option value="'+value.id+'">'+ value.Sub_district_Name  +'</option>');
										}
							...
							if(data['blocks'].length == 0){
								...
								data['blocks'].forEach(function (value,key) {
									if(vid!=0){
										...
										@if($candidate->pvillage_id > 0)
										if(value.id=={{$candidate->pvillage_id}}){
											$('#pvillage_id').append('<option selected value="'+value.id+'">'+ value.Block_Name  +'</option>');
										}else{
											$('#pvillage_id').append('<option value="'+value.id+'">'+ value.Block_Name  +'</option>');
										}
		...
		$(document).ready(function() {
			/*if($("#saa").is(':checked')){
				...
				showhideudid();
				$('#doc_twelveth_filename').html('12th Marksheet');
				$('#doc_tenth_filename').html('10th Marksheet');
			...
			console.log('T:'+$('#community_id').val());
            if($('#community_id').val()<2){
				console.log('c<2');
                $('#doc_community_form').addClass('hidden');
            }else{
