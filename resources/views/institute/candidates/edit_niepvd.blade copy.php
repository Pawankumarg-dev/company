						...
						<div class="panel-body">
							<table class="table table-bordered">
								...
								<tr>
									...
									<td>
										<input type="text" class="form-control" id="board_1" name="board_1" value="{{$candidate->educations->where('edugrade','10th')->first()->board}}" />
									</td>
									<td  style="width:80px;">
										<input type="text"  class="form-control year" id="yop_1" name="yop_1" value="{{$candidate->educations->where('edugrade','10th')->first()->yop}}" />
									</td>
									<td>
										<input type="text" class="form-control num year" id="tmarks_1" name="tmarks_1" value="{{$candidate->educations->where('edugrade','10th')->first()->tmarks}}" />
									</td>
									<td>
										<input type="text" class="form-control num year" id="omarks_1" onkeyup="javascript:calper(1);" name="omarks_1"  value="{{$candidate->educations->where('edugrade','10th')->first()->omarks}}"  >
									</td>
									<td>
										<input type="text" class="form-control" id="percentage_1" name="percentage_1"  value="{{$candidate->educations->where('edugrade','10th')->first()->percentage}}"   >
									</td>
									<td>
										<input type="text" class="form-control" id="subjects_1" name="subjects_1"  value="{{$candidate->educations->where('edugrade','10th')->first()->subjects}}" >
									</td>
								</tr>
								@endif

								@if($programme->programmegroup->twelveth== 1 && count($candidate->educations) > 1 )
								<tr>
								<td>
										12th *
