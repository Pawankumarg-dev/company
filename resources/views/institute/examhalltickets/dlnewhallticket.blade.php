                        ...
                        <table border="1" cellpadding="2" cellspacing="0" width="100%" class="h7-text">
                            ...
                            <tr>
                                ...
                                <td class="left-text blue-text bold-text" width="25%" colspan="2" rowspan="2">
                                    <b>(EXDL11)</b>  Hansraj College <br> Mahatma Hansraj Marg, Malkaganj <br> Delhi - 110007
                                </td>
                            ...
                            @foreach($applicationData as $application)
                                ...
                                <tr>
                                    ...
                                    <td class="center-text blue-text bold-text">
                                       @if($table->count() > 0)
                                        @if(str_contains($table->first()->examdate, '2023-09-09'))
                                            23-Sep-2023
                                        @endif
                                        @if(str_contains($table->first()->examdate, '2023-09-10'))
                                            30-Sep-2023
                                        @endif
                                        @endif
                                    </td>
