    ...
    <table border="1" cellpadding="5" cellspacing="0" width="100%">
        <tr>
            <td>
                <table border="0" cellpadding="3" cellspacing="0" width="100%">
                    <tr>
                        <td class="right-text" width="15%">
                            <img src="{{asset('/images/niepmd.png')}}"  style="width: 50px; height: 60px" class="img" />
                        </td>
                        <td class="h8-text center-text" width="85%">
        ...
        <tr>
            <td>
                <table border="1" cellpadding="2" cellspacing="0" width="100%" class="h7-text">
                    <tr>
                        <td class="center-text blue-text" colspan="6"><span class="h6-text bold-text">{{ $title }} - Hall Ticket</span></td>
                    </tr>
                    <tr>
                        <td class="left-text blue-text" width="15%"><i>Registration No.</i></td>
                        <td class="left-text blue-text bold-text" width="25%">{{ $candidate->enrolmentno }}</td>
                        <td class="left-text blue-text" width="15%"><i>Name</i></td>
                    ...
                    <tr>
                        <td class="left-text blue-text" width="15%"><i>Study Center</i></td>
                        <td class="left-text blue-text bold-text" width="25%" colspan="3">
                            ( {{ $institute->code }} ) - {{ $institute->name }}
                        </td>
                    </tr>
                    <tr>
                        <td class="left-text blue-text" width="15%" rowspan="2"><i>Exam Center</i>
                    ...
                    <tr>
                        <td class="center-text blue-text bold-text">
                            Zone Code: {{ $externalexamcenter->zone->code }}
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td width="70%">
                            ...
                            <div class="left-text blue-text">
                                <ol>
                                    <li>
                                        Report at the Examination Centre 30 minutes in advance before the commencement of the examination.
                                    </li>
                                    <li>
                                        Bring the Government Authorized Photo Identity Card in original (like Voter Id, Aadhaar Card, PAN Card) in proof of identity.
                                    </li>
                                    <li>
                                       Advised not to bring mobile phone(s) or any kind of electronic gadgets inside the Examination Hall.
                                    </li>
                                    <li>
                                        For any queries related to candidature, email to niepmd.examinations@gmail.com
                                    </li>
                                </ol>
                            </div>
                            <div class="right-text blue-text bold-text">
                                <br>
                                Signature of the Exam Centre Incharge / Centre Superintendent
                            </div>
                        </td>
                        <td class="center-text bold-text blue-text" style="vertical-align: bottom" width="15%">
                            <img src="{{asset('/images/hallticket/kavitha_adce_sign.png')}}"  style="width: 40px;" class="img" />

                            <br>ADCE,<br>NIEPMD-NBER
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td>
                <table border="0" cellpadding="3" cellspacing="0" width="100%" class="h7-text">
                    <tr>
                        <td class="center-text" width="20%" headers="30%">
                            @php
                                use CodeItNow\BarcodeBundle\Utils\QrCode;
                                $qrCode = new QrCode();
                                $qrCode
                                    ->setText($candidate->enrolmentno)
                                    ->setSize(100)
                                    ->setPadding(20)
                        ...
                        <td width="70%">
                            <div class="center-text">
                                <img src="{{asset('/images/hallticket/covid19-mar2021.jpg')}}"  style="width:60%; height: 40%" class="img" />
                            </div>
                        </td>
                    </tr>
                </table>
