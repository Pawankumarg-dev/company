                        ...
                        <table border="0" cellpadding="3" cellspacing="0" width="100%">
                            <tr>
                                <td class="center-text" width="15%">
                                    <img src="{{asset('/images/nber_logo.png')}}"  style="width: 50px; height: 60px" class="img" />
                                </td>
                                <td class="h8-text center-text" width="70%">
                                    <div class="center-text blue-text">
                                        <span class="h7-text bold-text">{{$nber->name}}</span><br>
                ...
                <tr>
                    <td>
                        <table border="1" cellpadding="2" cellspacing="0" width="100%" class="h7-text">
                            <tr>
                                <td class="center-text blue-text" colspan="6"><span class="h6-text bold-text"> 2023 Examinations - Hall Ticket</span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              {{--  <td class="left-text blue-text" width="15%"><i>Exam Center</i>
                                ...
                                <td class="center-text blue-text bold-text" style="vertical-align: bottom" colspan="3">
                                    <br><br><br>
                    ...
                    <td>
                        <table border="1" cellpadding="3" cellspacing="0" width="100%" class="h7-text">
                            <tr>
                                ...
                                <td class="center-text blue-text bold-text" width="5%">Subject<br>Code</td>
                ...
                <tr>
                    <td>
                        <table border="1" cellpadding="3" cellspacing="0" width="100%" class="h7-text">
                            <tr>
                                <td width="25%">
                                  {{--  <div class="center-text hidden">
                                        <img src="{{asset('/images/hallticket/covid19-nov2021.jpg')}}"  style="width:60%; height: 40%" class="img" />
                                    </div> --}} 
                                </td>
                                <td width="25%" valign="bottom" style="min-height:100px;height:100px;">
                                ...
                                <td class="center-text bold-text blue-text hidden" width="15%">
                                 {{--   <img src="{{asset('/images/hallticket/Dr_Balabaskar.png')}}"  style="width: 80px;" class="img" />

                                    <br>I/c NBER,<br> {{$nber->name_code}} --}}
                                </td>
                            </tr>
                        </table>
                    </td>
                                    ...
                                    <div class="left-text blue-text">
                                        <ol>
                                            <li class="custom-li-style bold-text">
                                                ...
                                                Certificates. If correction(s) needed, report immediately to {{$nber->name_code}}-NBER through your study centre before the declaration of results.
                                                <span class="h8-text">
