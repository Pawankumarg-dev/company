                                            ...
                                            <tr>
                                                ...
                                                @if($examappliedcandidatecount != 0)
                                                    ...
                                                    @if($exam->attendance_upload == 1)
                                                            <td class="center-text">
                                                                <a href="{{url('halltickets/'.$approvedprogramme->id).'/'.$exam->id}}" class="btn btn-primary btn-sm"><i class="fa fa-th"></i> &nbsp;&nbsp;Attendance</a>
                                                            </td>
                                                        @else
                                                        <td>
                                                    ...
                                                    @endif
                                                        @if($exam->hallticket_download == 1)
                                                            <td class="center-text">
                                                                @if($approvedprogramme->applications->where('exam_id', $exam->id)->count() != 0)
                                                                    <a href="{{url('/institute/hallticket-download/'.$exam->id.'/show-candidates-list/'.$approvedprogramme->id)}}" class="btn btn-info btn-sm"><i class="fa fa-th"></i> &nbsp;&nbsp;Theory Hallticket</a>
                                                                @endif
                                                            </td>
                                                        @else
                                                            <td>
