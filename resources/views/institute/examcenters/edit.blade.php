...
<div class="container">
    ...
    <form action="{{ url('/') }}/institute/examcenters/update" method="POST" id="schoolForm" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <div class="row">
 ...
 <div class="form-group col-md-12">
    ...
    <input type="text" class="form-control" value="{{$school->name}}" required onkeypress="return /[A-Z0-9a-z_ ,.]/.test(event.key)" name="name" id="school_name">
</div>
<!-- State -->
<div class="form-group col-md-4">
    ...
    <select name="lgstate_id" class="form-control" id="state_id" required>
        ...
        @foreach ($states as $state)
            <option <?php if($state->id==$school->lgstate_id){ echo "selected";} ?> value="{{$state->id}}">{{$state->state_name}}</option>
        @endforeach
    </select>
</div>
...
<div class="form-group col-md-4">
    ...
    <select name="district" class="form-control" id="district_id" required>
        ...
        @foreach ($districts as $district)
            <option <?php if($district->id==$school->district){ echo "selected";} ?> value="{{$district->id}}">{{$district->districtName}}</option>
        @endforeach
    </select>
</div>
...
<div class="form-group col-md-4">
    ...
    <select name="subdistrict" class="form-control" id="subdistrict_id" required>
        ...
        @foreach ($subdistricts as $subdistrict)
            <option <?php if($subdistrict->id==$school->subdistrict){ echo "selected";} ?> value="{{$subdistrict->id}}">{{$subdistrict->District_Name}}</option>
        @endforeach
    </select>
</div>
...
<div class="form-group col-md-4">
    ...
    <select name="village" class="form-control" id="village_id">
        ...
        @foreach ($villages as $village)
            <option  <?php if($village->id==$school->village_id){ echo "selected";} ?> value="{{$village->id}}">{{$village->Block_Name}}</option>
        @endforeach
    </select>
</div>
...
<div class="form-group col-md-4">
    ...
    <input type="text" class="form-control"  value="{{$school->address}}" required name="address" onkeypress="return /[A-Z0-9a-z_ ,./-]/.test(event.key)" id="address">
</div>
<!-- Pincode -->
<div class="form-group col-md-4">
    <label for="pincode">Pincode</label>
    <input type="text" class="form-control"  value="{{$school->pincode}}" required onkeypress="return /[0-9]/.test(event.key)" name="pincode" maxlength="6" id="pincode" oninput="validatePin()">
</div>  

<!-- Latitude -->
<div class="form-group col-md-6">
    <label for="latitudeInput" class="form-label">Latitude</label>
    <input type="text" class="form-control" required id="latitudeInput" name="latitude"  value="{{$school->latitude}}" onkeypress="return /[0-9.]/.test(event.key)" placeholder="Enter latitude (e.g., 40.748817)">
...
<div class="form-group col-md-6">
    ...
    <input type="text" class="form-control" required id="longitudeInput" name="longitude"  value="{{$school->longitude}}" onkeypress="return /[0-9.]/.test(event.key)" placeholder="Enter longitude (e.g., -73.985428)">
...
<div class="form-group col-md-3">
    ...
    <input type="text" class="form-control" required name="principal_name"  value="{{$school->principal_name}}" onkeypress="return /[A-Za-z_ ,./-]/.test(event.key)" id="principal_name">
</div>

<!-- Principal's Email -->
<div class="form-group col-md-3">
    <label for="principal_email">Principal's Email</label>
    <input type="email" class="form-control" required  value="{{$school->email1}}" name="email1" id="principal_email">
</div><br>

<!-- Principal's Mobile -->
<div class="form-group col-md-3">
    <label for="principal_mobile">Principal's Mobile</label>
    <input type="text" class="form-control" required  value="{{$school->principal_mobile}}" name="principal_mobile" maxlength="10" id="principal_mobile" onkeypress="return /[0-9]/.test(event.key)">
</div>

<!-- Principal's WhatsApp -->
<div class="form-group col-md-3">
    <label for="principal_whatsapp">Principal's WhatsApp</label>
    <input type="text" class="form-control" required  value="{{$school->principal_whatsapp}}" name="principal_whatsapp" maxlength="10" id="principal_whatsapp" onkeypress="return /[0-9]/.test(event.key)">
</div>

<!-- Alternative Contact Person -->
<div class="form-group col-md-3">
    <label for="alternative_contact_person">Alternative Contact Person</label>
    <input type="text" class="form-control" required  value="{{$school->contactperson}}" name="contactperson" id="alternative_contact_person">
</div>

<!-- Alternative Designation -->
<div class="form-group col-md-3">
    <label for="alternative_designation">Alternative Contact Person Designation</label>
    <input type="text" class="form-control" required  value="{{$school->alternative_designation}}" name="alternative_designation" id="alternative_designation">
</div>

<!-- Alternative Contact Email -->
<div class="form-group col-md-3">
    <label for="alternative_contact_email">Alternative Contact Person Email</label>
    <input type="email" class="form-control"  value="{{$school->email2}}" required name="email2" id="email2">
</div>

<!-- Alternative Contact Mobile -->
<div class="form-group col-md-3">
    <label for="alternative_contact_mobile">Alternative Contact Person Mobile</label>
    <input type="text" class="form-control"  value="{{$school->contactnumber1}}" required name="contactnumber1" maxlength="10" onkeypress="return /[0-9]/.test(event.key)" id="alternative_contact_mobile">
</div>

<!-- Alternative Contact WhatsApp -->
<div class="form-group col-md-3">
    <label for="alternative_contact_whatsapp">Alternative Contact Person WhatsApp</label>
    <input type="text" class="form-control"  value="{{$school->contactnumber2}}" required name="contactnumber2" maxlength="10" onkeypress="return /[0-9]/.test(event.key)" id="alternative_contact_whatsapp">
</div>
...
<div class="form-group col-md-6">
    ...
    <input type="radio" id="principal-superintendent-yes" name="superintendent" <?php if($school->superintendent=='1'){ echo "checked";} ?>  value="1" onclick="checkSelection()" required>
    <label for="principal-superintendent-yes">Yes</label>
    <input type="radio" id="principal-superintendent-no" name="superintendent" <?php if($school->superintendent=='0'){ echo "checked";} ?>  value="0" onclick="checkSelection()" required>
...
<input type="radio" id="exam-centre-superintendent-yes" name="superintendent_declearation" <?php if($school->superintendent_declearation=='1'){ echo "checked";} ?> value="1" onclick="checkSelection()" required>
<label for="exam-centre-superintendent-yes">Yes</label>
<input type="radio" id="exam-centre-superintendent-no" name="superintendent_declearation" value="0" <?php if($school->superintendent_declearation=='0'){ echo "checked";} ?> onclick="checkSelection()" required>
...
<div class="row" id="checkSelection">
<div class="box">
     <!-- Setting Capacity -->
<div class="form-group col-md-6">
    <label for="setting_capacity">Seatting Capacity Per Room <small class="form-text text-muted">one student on each bench</small>
    </label>
    <input type="number" class="form-control" required   value="{{$school->seats_per_room}}" name="seats_per_room" onkeypress="return /[0-9]/.test(event.key)" id="setting_capacity">
...
<div class="form-group col-md-6">
    ...
    <input type="number" class="form-control" name="classroom_count"  value="{{$school->classroom_count}}" onkeypress="return /[0-9]/.test(event.key)"  id="seats_per_room">
</div>
<hr>
...
<input type="radio" id="100-students" name="session_min_capacity" value="100"  <?php if($school->session_min_capacity=='100'){ echo "checked";} ?> required>
<label for="100-students">100 students</label>
<input type="radio" id="300-students" name="session_min_capacity" value="300" <?php if($school->session_min_capacity=='300'){ echo "checked";} ?> required>
<label for="300-students">300 students</label>
<input type="radio" id="500-students" name="session_min_capacity" value="500" <?php if($school->session_min_capacity=='500'){ echo "checked";} ?> required>
<label for="500-students">500 students</label>
<input type="radio" id="more-than-500-students" name="session_min_capacity" <?php if($school->session_min_capacity=='more-than-500'){ echo "checked";} ?> value="more-than-500" required>
...
<input type="radio" id="5-classrooms" name="classrooms" value="5" <?php if($school->classrooms=='5'){ echo "checked";} ?> required>
<label for="5-classrooms"> 5 classrooms</label>
<input type="radio" id="15-classrooms" name="classrooms" value="15" <?php if($school->classrooms=='15'){ echo "checked";} ?> required>
<label for="15-classrooms">15 classrooms</label>
<input type="radio" id="25-classrooms" name="classrooms" value="25" <?php if($school->classrooms=='25'){ echo "checked";} ?> required>
...
<input type="radio" id="washrooms-yes" name="washrooms" value="1" <?php if($school->washrooms=='1'){ echo "checked";} ?> required>
<label for="washrooms-yes">Yes</label>
<input type="radio" id="washrooms-no" name="washrooms" value="0" <?php if($school->washrooms=='0'){ echo "checked";} ?> required>
...
<input type="radio" id="cctv-facility-yes" name="cctv_facility" value="1" <?php if($school->cctv_facility=='1'){ echo "checked";} ?> required>
<label for="cctv-facility-yes">Yes</label>
<input type="radio" id="cctv-facility-no" name="cctv_facility" value="0" <?php if($school->cctv_facility=='0'){ echo "checked";} ?> required>
...
<input type="radio" id="5-computers" name="computers" value="5" <?php if($school->computers=='5'){ echo "checked";} ?> required>
<label for="5-computers">5 computers</label>
<input type="radio" id="3-computers" name="computers" value="3" <?php if($school->computers=='3'){ echo "checked";} ?> required>
<label for="3-computers">3 computers</label>
<input type="radio" id="2-computers" name="computers" value="2" <?php if($school->computers=='2'){ echo "checked";} ?> required>
...
<input type="radio" id="2-printers" name="printers" value="2" <?php if($school->printers=='2'){ echo "checked";} ?> required>
<label for="2-printers">2 printers</label>
<input type="radio" id="3-printers" name="printers" value="3" <?php if($school->printers=='3'){ echo "checked";} ?> required>
<label for="3-printers">3 printers</label>
<input type="radio" id="5-printers" name="printers" value="5" <?php if($school->printers=='5'){ echo "checked";} ?> required>
...
<input type="radio" id="1-photocopier" name="photocopiers" value="1" <?php if($school->photocopiers=='1'){ echo "checked";} ?> required>
<label for="1-photocopier">1 photocopier</label>
<input type="radio" id="2-photocopiers" name="photocopiers" value="2" <?php if($school->photocopiers=='2'){ echo "checked";} ?> required>
<label for="2-photocopiers">2 photocopiers</label>
<input type="radio" id="4-photocopiers" name="photocopiers" value="4" <?php if($school->photocopiers=='4'){ echo "checked";} ?> required>
...
<input type="radio" id="2-scanners" name="scanners" value="2" <?php if($school->scanners=='2'){ echo "checked";} ?> required>
<label for="2-scanners">2 scanners</label>
<input type="radio" id="3-scanners" name="scanners" value="3" <?php if($school->scanners=='3'){ echo "checked";} ?> required>
<label for="3-scanners">3 scanners</label>
<input type="radio" id="4-scanners" name="scanners" value="4" <?php if($school->scanners=='4'){ echo "checked";} ?> required>
...
<input type="radio" id="2-support-staff" name="support_staff" value="2" <?php if($school->support_staff=='2'){ echo "checked";} ?> required>
<label for="2-support-staff">2 staff</label>
<input type="radio" id="4-support-staff" name="support_staff" value="4" <?php if($school->support_staff=='4'){ echo "checked";} ?> required>
<label for="4-support-staff">4 staff</label>
<input type="radio" id="6-support-staff" name="support_staff" value="6" <?php if($school->support_staff=='6'){ echo "checked";} ?> required>
...
<input type="radio" id="2-technical-staff" name="technical_staff" value="2" <?php if($school->technical_staff=='2'){ echo "checked";} ?> required>
<label for="2-technical-staff">2 staff</label>
<input type="radio" id="4-technical-staff" name="technical_staff" value="4" <?php if($school->technical_staff=='4'){ echo "checked";} ?> required>
<label for="4-technical-staff">4 staff</label>
<input type="radio" id="6-technical-staff" name="technical_staff" value="6" <?php if($school->technical_staff=='6'){ echo "checked";} ?> required>
...
<?php $accessibility = json_decode($school->accessibility, true); ?>
...
<input type="checkbox" id="ramp" name="accessibility[]" value="Ramp" <?php if(in_array('Ramp', $accessibility)){ echo "checked";} ?>>
<label for="ramp">Ramp</label>
<input type="checkbox" id="disabled-friendly-toilets" name="accessibility[]" value="Disabled-friendly toilets" <?php if(in_array('Disabled-friendly toilets', $accessibility)){ echo "checked";} ?>>
<label for="disabled-friendly-toilets">Disabled-friendly toilets</label>
<input type="checkbox" id="lift" name="accessibility[]" value="Lift" <?php if(in_array('Lift', $accessibility)){ echo "checked";} ?>>
<label for="lift">Lift</label>
<input type="checkbox" id="speaker-system" name="accessibility[]" value="Speaker system" <?php if(in_array('Speaker system', $accessibility)){ echo "checked";} ?>>
<label for="speaker-system">Speaker system</label>
<input type="checkbox" id="all" name="accessibility[]" value="All" <?php if(in_array('All', $accessibility)){ echo "checked";} ?>>
...
<input type="radio" id="ground-floor" name="drinking_water" value="ground-floor" <?php if($school->drinking_water=='ground-floor'){ echo "checked";} ?> required>
<label for="ground-floor">At ground floor</label>
<input type="radio" id="all-floors" name="drinking_water" value="all-floors"  <?php if($school->drinking_water=='all-floors'){ echo "checked";} ?> required>
...
<input type="radio" id="1-guard" name="security_guards" value="1" <?php if($school->security_guards=='1'){ echo "checked";} ?> required>
<label for="1-guard">1 guard at a time</label>
<input type="radio" id="2-guards" name="security_guards" value="2" <?php if($school->security_guards=='2'){ echo "checked";} ?> required>
<label for="2-guards">2 guards at a time</label>
<input type="radio" id="4-guards" name="security_guards" value="4" <?php if($school->security_guards=='4'){ echo "checked";} ?> required>
...
<input type="radio" id="open-space-yes" name="open_space" value="1" <?php if($school->open_space=='1'){ echo "checked";} ?> required>
<label for="open-space-yes">Yes</label>
<input type="radio" id="open-space-no" name="open_space" value="0" <?php if($school->open_space=='0'){ echo "checked";} ?> required>
...
<input type="radio" id="special-permissions-yes" name="permission" value="1" <?php if($school->permission=='1'){ echo "checked";} ?> onclick="checkSelection2()" required>
<label for="special-permissions-yes">Yes</label>
<input type="radio" id="special-permissions-no" name="permission" value="0" <?php if($school->permission=='0'){ echo "checked";} ?> onclick="checkSelection2()" required>
...
<div class="form-group col-md-6" id="checkSelection2" style="display: none">
    ...
    <textarea id="special-permissions-details" name="special_permissions_details" rows="4" cols="70">{{$school->special_permissions_details}}</textarea>            
</div>
</div>
</div>
...
<input type="text" class="form-control" required name="nearest_police_station"  value="{{$school->nearest_police_station}}" onkeypress="return /[A-Z0-9a-z_ ,./-]/.test(event.key)" id="nearest_police_station">
</div>

<!-- Nearest Post Office -->
<div class="form-group col-md-6">
<label for="nearest_post_office">Nearest Post Office</label>
<input type="text" class="form-control" required name="nearest_post_office" value="{{$school->nearest_post_office}}" onkeypress="return /[A-Z0-9a-z_ ,./-]/.test(event.key)" id="nearest_post_office">
</div>
...
<div class="form-group col-md-6">
    ...
    <input type="text" class="form-control" required name="district_officer_name" value="{{$school->district_officer_name}}" id="district_officer_name">
</div>

<!-- District Officer's Mobile -->
<div class="form-group col-md-6">
    <label for="district_officer_mobile">District Officer's Mobile</label>
    <input type="text" class="form-control" required name="district_officer_mobile" value="{{$school->district_officer_mobile}}" id="district_officer_mobile" maxlength="10" onkeypress="return /[0-9]/.test(event.key)">
</div>
...
<div class="form-group col-md-6">
    ...
    <select name="bank_name" class="form-control" id="bank_name" required>
        ...
        @foreach ($banks as $bank)
            <option <?php if($bank->id==$school->bank_name){ echo "selected";} ?> value="{{$bank->id}}">{{$bank->bankname}}</option>
        @endforeach
    </select>
</div>
...
<div class="form-group col-md-6">
    ...
    <input type="text" class="form-control" required value="{{$school->account_holder_name}}" name="account_holder_name" id="account_holder_name">
</div>

<!-- Account Number -->
<div class="form-group col-md-4">
    <label for="account_number">Account Number</label>
    <input type="text" class="form-control" required value="{{$school->account_number}}" name="account_number" id="account_number" onkeypress="return /[0-9]/.test(event.key)">
</div>

<!-- Branch -->
<div class="form-group col-md-4">
    <label for="branch">Branch</label>
    <input type="text" class="form-control" required value="{{$school->branch}}" name="branch" id="branch">
</div>

<!-- IFSC Code -->
<div class="form-group col-md-4">
    <label for="ifsc_code">IFSC Code</label>
    <input type="text" class="form-control" required value="{{$school->ifsc_code}}" name="ifsc_code" id="ifsc_code">
</div>
...
<!-- Consent Form Upload -->
<div class="form-group col-md-6">
    <label for="consent_form">Upload Declaration / Consent Form with Stamp & Signature</label>
    <input type="file" class="form-control" id="consent_form" name="consent_form" accept=".jpg, .jpeg, .png, .pdf" onchange="validateFile()">

    <div id="error-message" style="color: red; display: none;"></div>
</div>

<!-- Submit Button -->
<div class="col-md-12" id="submit_data">
