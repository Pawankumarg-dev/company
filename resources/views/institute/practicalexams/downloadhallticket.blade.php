                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-condensed table-borderless" role="table">
                        ...
                        <tr>
                            <td class="left-text blue-text">
                                <ol>
                                    <li>Candidates should report at the Examination Center 30 minutes before the commencement of the examination.</li>
                                    <li>Candidates will not be allowed to enter the Examination Hall without the Hall ticket under any circumstances.</li>
                                    <li>Candidates must bring their orignial Government Authorised Photo Identity Card (like Voter Id Card, Aadhaar Card, PAN Card) in proof of their identity.</li>
                                    <li>Candidates are advised not to bring mobile phone(s) or any kind of electronic gadgets inside the Examination Hall.</li>
                                    <li>Candidates should bring all the practical examination materials (i.e.,) records and teaching learning material (TLM).</li>
                                </ol>
                            </td>
                        </tr>
                        <tr>
