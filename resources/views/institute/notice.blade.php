...
<div class="container">
    <div class="alert alert-success ">
        ...
        <p>
            Payment of Affiliation Fees for the academic years <strong>2024–25 & 2025–26</strong> and enrolment
            (registration) fees of students must be paid as per norms in SOE.
        </p>
        ...
        <p>
            Fees may be paid through the <strong>payment gateway</strong>. If already paid, details must be submitted in
            the format provided on the dashboard.
        </p>

        <p class="text-danger">
            <strong>Note:</strong> In case of non-receipt of the above-mentioned fees, hall tickets may not be
            generated.
        </p>
    ...
    <div class="alert alert-success hidden">
        <h4>
            <a href="https://nber-rehabcouncil.gov.in/files/notice/SupplementarycircularTTIstudents_0001.pdf"
                target="_blank">Circular for Supplementary exam 2026</a>
        </h4>
    </div>
    <div class="row">
...
?>
                    <tr>
                        ...
                        <td class="">
                            ...
                            {{-- <form action="{{url('/')}}/eparivesh2" method="post" style="padding:5px"
                            calss="hidden">
                            {{ csrf_field() }}
                            ...
                            <a
                                href="{{ url('/') }}/eparivesh/{{ base64_encode($item->id) }}/{{ base64_encode($item->programme_id) }}"><button
                                    class="btn btn-primary">Admission with ePravesh Registation</button></a>

                            <a href="{{ url('/') }}/eparivesh/addcandidate/48245/{{$item->id}}"><button
                                    class="btn btn-primary">Direct Admission</button></a>
...
$formatted_date = \Carbon\Carbon::parse($item->start_date)->format('d/m/Y');
...
@if(\Carbon\Carbon::now()->greaterThanOrEqualTo(\Carbon\Carbon::parse($item->start_date)))
                            {{ $item->name }}
                            @endif
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="alert alert-success ">
                <h4>
                    <a href="{{url('/')}}/files/notice/SOP for TTI to fill online Admission Form 2025.pdf"
                        target="_blank">Guidelince to Fill Online Admission Form 2025 </a>
                </h4>
            </div>
            <div class="alert alert-success ">
                <h4>
                    <a href="{{url('/')}}/files/notice/SOP_Intitutions_2025.pdf" target="_blank">SOP for Admission
                        2025</a>
                </h4>
            </div>
            <div class="alert alert-success ">
                <h4>
                    <a href="https://nber-rehabcouncil.gov.in/files/notice/Circular_TTI_June_2025_exam.pdf"
                        target="_blank">Circular for June exam 2025</a>
                </h4>
            </div>
            @if(Auth::user()->id==133861)
            <div class="alert alert-success hidden">
                <h4>
                    The online application for examination is open on 03/06/2025 from 8:30 AM to 6:00 PM. Enrollment fee
                    is exempted. However, examination fee as per the scheme of examination i.e ₹100 per paper (theory
                    and practical),
                </h4>
            </div>
            @endif
            <div class="alert alert-danger hidden">
                ...
                <ul>
                    <li>
                        All eligible students undergoing Diploma/Certificate level courses can apply w.e.f. 28th March –
                        07th April 2025 without late fees and 08th April – 12th April 2025 with late fees.
                    </li>
                    ...
                    <li>
                        Hall tickets will be generated for the eligible candidates to appear for exams subject to
                        completion of following conditions:
                        <ul>
                            <li>
                    ...
                    <li>
                        Students can make the payment for examination, after the attendance and internal marks are
                        uploaded to the portal.
                    </li>
                    <li>
                        All students eligible as per section C.2.3 of Scheme of Exam, 2024 can apply (The condition of
                        maximumnumber of chances is relaxed as a special case).
                    </li>
                    <li>
                        No further chances will be considered for the students in future if they do not meet conditions
                        laid at section C.2.3 as per Scheme of Exam, 2025.
                    </li>
                    <li>
                        Students needs to select both Theory and practical papers
                    </li>
                    <li>
                        Papers with only internal also to be selected (Payment will be only for external theory and
                        practical)
                    </li>
                </ul>
                <br />
                ...
                <ul>
                    <li>डिप्लोमा/सर्टिफिकेट स्तर के पाठ्यक्रमों में अध्ययनरत सभी पात्र छात्र 28 मार्च से 07 अप्रैल 2025
                        तक बिना विलम्ब शुल्क के तथा 08 अप्रैल से 12 अप्रैल 2025 तक विलम्ब शुल्क के साथ आवेदन कर सकते
                        हैं।</li>

                    <li>टीटीआई द्वारा 21 मई से 30 मई 2025 तक हॉल टिकट मुद्रित और जारी किए जाएंगे।</li>
                    <li>
                        निम्नलिखित शर्तों को पूरा करने के अधीन पात्र उम्मीदवारों को परीक्षा में शामिल होने के लिए हॉल
                        टिकट तैयार किए जाएंगे:
                        <ul>
                            <li>
                    ...
                    <li>परीक्षा योजना, 2024 की धारा C.2.3 के अनुसार पात्र सभी छात्र आवेदन कर सकते हैं (विशेष मामले के
                        रूप में अधिकतम अवसरों की शर्त में छूट दी गई है)।</li>
                    <li>
                        यदि छात्र परीक्षा योजना, 2025 के अनुसार धारा C.2.3 में निर्धारित शर्तों को पूरा नहीं करते हैं,
                        तो भविष्य में उनके लिए कोई और अवसर नहीं माना जाएगा।
                    </li>
                    <li>
                        छात्रों को थ्योरी और प्रैक्टिकल दोनों पेपर चुनने होंगे केवल आंतरिक वाले पेपर भी चुने जाने हैं
                        (भुगतान केवल बाहरी थ्योरी और प्रैक्टिकल के लिए होगा)
            ...
            <div class="alert alert-success hidden">
                ...
                <li>
                    Consent from 3 Govt. schools / CBSE direct affiliated school to conduct exams scheduled in June
                    2025:
                    ...
                    <ul>
                        ...
                        <li>
                            b. Get the details of the exam center filled by the Govt. school/ CBSE direct affiliated
                            school.
                        </li>
                        <li>
                ...
                <P><strong>Note: </strong> consent form is mandatory to be submitted even if earlier submitted. The
                    portal for uploading the format will be open as per the schedule submitted. No further extension
            ...
            <div class="alert alert-danger">
                ...
                <p>
                    <b>Instructions:</b> Click <a href="{{ url('files/Instructions_TTI.pdf') }}">here</a> to download
            ...
            <div class="alert alert-info hidden">
                ...
                <p>
                    ...
                    Click <a target="_blank" href="{{url('files')}}/Enrolment 2024.pdf">here</a> to read step by step
                    instructions for uploading 2024 Enrolment data to the portal.
                </p>
            </div>
            <div class="alert alert-danger hidden">
                <h4>Practical Examination</h4>
                <p>
                    Practical examiners are provided with user name and password to login to the portal to download
                    marksheet format and to upload the practical exam marks.
            ...
            <div class="alert alert-success hidden">
                ...
                <p>
                    Practical halltickets can be downloaded from the Examination -> June 2024 Exam -> Exam Applications
                    & Halltickets page.
                </p>
            </div>
            <div class="alert alert-success hidden">
                ...
                <p>
                    Internal marks can be entered from Examination -> June 2024 Exam page by clicking on links in
            ...
            <div class="alert alert-danger" style="display: none;">
                ...
                All the TTIs who have not uploaded the data of the students may upload latest by 30th March 2024,
            ...
            @if($institute->is_data_verified !=1 || $institute->is_mobile_verified !=1 || $institute->is_email_verified
            !=1 || $institute->is_institute_head_verified !=1 || $institute->is_institute_head_email_verified !=1 ||
            $institute->is_institute_head_mobile_verified !=1 || $institute->is_facilities_verified !=1)
            ...
            <div class="alert alert-danger" style="display: none;">
                <b>Important Announcement: </b> For online generation of marks cards and certificates, all the heads of
                the training institutes are advised to upload all candidate data including Aadhar card number, mobile
                number and email etc. on this portal.
            ...
            <div class="alert alert-warning" style="display: none;">
                <b>Add Faculties: </b>
                Information of the faculty and their CRR details in each NI / TTI which are running various courses of
                RCI has to be updated.
            ...
            <div class="alert alert-info">
                You have not updated the password recently. Click <a
                    href="{{url('/institute/changepassword')}}">here</a> to change password.
            </div>
            @endif
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        To change any other data like DOB ,Father name etc. Please click on Edit and update the correct
                        data.
                    </li>
                    <li>
                        <b>Note:</b> Enrolment number and Name cannot be edited by TTI. If any correction required
                        please contact the respective NBERs using the <b>
            ...
            <li>
                Incase of any data queries please use the Data Correction Requests form to communicate with NBER to
                correct any data.
                <br>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <a href="{{ url('/images/notice/Circular-nsp.pdf') }}" class="btn btn-info btn-xs"
                            download>Download Notification</a>
                        ...
                        <form action="{{url('/')}}/update-nsp" method="POST">
                            ...
                            <div class="row" style="padding: 20px">
                                ...
                                <div class="group-form">
                                    <label for="state_nsp" class="form-label">State Govt. Scholarship Portal Registation
                                        No.</label>
                                    <input type="text" class="form-control" id="state_nsp" maxlength="50"
                                        name="state_nsp" value="<?=$institute_location->state_nsp ?>">
                                </div>

                                <!-- National NSP Field -->
                                <div class="group-form">
                                    <label for="national_nsp" class="form-label">National Scholarship Portal Registation
                                        No.</label>
                                    <input type="text" class="form-control" id="national_nsp" maxlength="50"
                                        name="national_nsp" value="<?=$institute_location->national_nsp ?>">
                                </div>
