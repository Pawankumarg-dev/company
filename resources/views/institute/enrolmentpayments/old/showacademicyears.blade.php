                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <div class="row">
                                <div class="col-sm-9">Payment for Enrolment {{ $currentyear->year }}</div>
                                <div class="col-sm-3">
                                    <div class="text-right">
                                        <a href="{{ url('/institute/enrolmentpayments/selectstudents'.'/'.$currentyear->id) }}" class="btn btn-primary">Add Enrolment Payment {{ $currentyear->year }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-striped table-hover table-condensed">
                            ...
                            @foreach($enrolmentpayments->sortByDesc('reference_number') as $ep)
                                <tr>
                                    <td>{{ $sno }}</td>
                                    <td>{{ $ep->enrolmentfee->academicyear->year }}</td>
                                    ...
                                    <td>
                                        <a href="{{ url('/institute/enrolmentpayments/download/'.$ep->reference_number) }}"
