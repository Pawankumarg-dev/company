        ...
        <div class="col-sm-12 well well-sm white-background minus15px-margin-top">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" width="100%" style="vertical-align: center">
                                    <thead>
                                    <tr>
                                        <th class="bg-info" width="5%">
                                            Code
                                        </th>
                                        <th class="bg-info blue-text" width="95%">
                                            {{ $institute->code }}
                                        </th>
                                    </tr>
                                    <tr>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading left-text">
                            Institute's Communication Details
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tr>
                                        <th class="bg-info" width="10%">
                                            Pincode
                                            <span class="red-text">(mandatory)</span>
                                        </th>
                                        <th class="bg-info blue-text" width="95%">
                                            <div class="col-sm-2">
                                    ...
                                    <tr>
                                        ...
                                        <th class="bg-info blue-text" width="95%">
                                            <div class="col-sm-4">
                                                <select class="form-control" name="mystate" id="mystate" @if($institute->edit_status == '1') disabled @endif>
                                                    ...
                                                    @else
                                                        ...
                                                        @foreach($states as $s)
                                                            <option value="{{ $s->id }}"
                                                                    @if($institute->city->state->id == $s->id)
                                                                    selected
                                                                    @endif
                                                            >{{ $s->state_name }}</option>
                                                        @endforeach
                                    ...
                                    <tr>
                                        ...
                                        <th class="bg-info blue-text" width="95%">
                                            <div class="col-sm-4">
                                                <select class="form-control" name="mycity" id="mycity" @if($institute->edit_status == '1') disabled @endif>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="postoffice" name="postoffice"
                                                               value="{{ strtoupper($institute->postoffice) }}"

                                                               @if($institute->edit_status == '1') disabled @endif
                                                        />
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <span class="red-text" style="font-size: large">
                                                        (Please enter the name of the Post Office nearby only.)
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <th class="bg-info blue-text" width="95%">
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="street_address" name="street_address"
                                                       value="{{ strtoupper($institute->street_address) }}"
                                            ...
                                            <div class="col-sm-12">
                                                        <span class="red-text" style="font-size: large">
                                                        (Please do not enter State / District / Pincode / Post Office here)
                                                        </span>
                                            </div>
                                        </th>
                                    </tr>
                                        ...
                                        <th class="bg-info blue-text" width="95%">
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="landmark" name="landmark"
                                                       value="{{ strtoupper($institute->landmark) }}"
            ...
            if(stateID){
                $.ajax({
                    ...
                    success:function(res){
                        if(res){
                            $("#mycity").empty();
                            $("#mycity").append('<option value="0">-- Select District --</option>');

                            $.each(res, function () {
                                $("#mycity").append('<option value="'+this.id+'">'+this.name+'</option>');
                            })
...
{{--
            $.ajax({
                url: "{{ url('/institute/center-information/getcities') }}",
                method: "POST",
                data: { state_id : state_id},
                dataType: "JSON",
                success:function (data) {
                    $(data).each(function () {
                        $('#mycity').append($('<option>').val(data['id']).text(data['name']));
                    })
                }
            });
            ...
            success: function(result){
                            $('#mycity').append($('<option>').val(state_id).text(id));
                        }});
