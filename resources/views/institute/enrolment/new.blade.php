    ...
    <section class="container">
        <div class="row">
            ...
            <div class="col-sm-10 well well-sm white-background minus15px-margin-top">
                ...
                <form class="form-horizontal" action="{{url('/enrolment/checkCourse')}}" method="post"
                      accept-charset="UTF-8" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-group {{ $errors->has('maxintake') ? 'has-error' : '' }}">
                        <label for="maxintake" class="control-label col-sm-3">
                            <div class="" style="text-align: left !important;">Maximum Intake capacity for Candidates (As per RCI Approval)</div>
                        </label>
                        <div class="col-sm-2">
                            <input type="number" class="form-control" id="maxintake" name="maxintake"
                                   value="{{ old('maxintake') }}"/>
