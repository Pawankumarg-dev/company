...
@section('content')
    ...
    <form class="form-horizontal" action="{{url('/institute/payment/enrolment/academicyear/'.$academicyear->id.'/checkstudentdetails')}}"
          method="post">
        {{csrf_field()}}
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-stripped">
                                <caption class="text-bold">Select the candidates for Enrolment Payment </caption>
                                <tr>
                                    <th>Select</th>
                                    <th>Academicyear</th>
                                    <th>Programme</th>
