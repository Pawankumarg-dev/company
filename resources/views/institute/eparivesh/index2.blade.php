...
<div class="container">
    <h2>2nd Merit List of {{$approve_program->institute->rci_code}}/ {{$programme->abbreviation}} Students</h2>



    <div style="padding-bottom: 30px">
        <form method="post" action="{{url('/')}}/eparivesh2" class="row g-3 mb-4">
            {!! csrf_field() !!}
            ...
            <div class="col-md-4">
                ...
                <select name="category" class="form-control">
                    ...
                    <option value="SCHEDULED CASTE (SC)"
                        {{ request('category') == 'SCHEDULED CASTE (SC)' ? 'selected' : '' }}>SCHEDULED CASTE (SC)
                    </option>
                    <option value="SCHEDULED TRIBE (ST)"
                        {{ request('category') == 'SCHEDULED TRIBE (ST)' ? 'selected' : '' }}>SCHEDULED TRIBE (ST)
                    </option>
            ...
            <div class="col-md-4">
                ...
                <select name="gender" class="form-control">
                    ...
                    <option value="2" {{ request('FEMALE') == 'FEMALE' ? 'selected' : '' }}>FEMALE</option>
                    <option value="1" {{ request('gender') == 'MALE' ? 'selected' : '' }}>MALE</option>
                    <option value="3" {{ request('gender') == 'TRANSGENDER' ? 'selected' : '' }}>TRANSGENDER</option>
                </select>
            </div>
...
<button onclick="printMeritList()" class="btn btn-success">🖨️ Print Merit List</button>

            </div>
          
        </form>
<h4><strong>Note:</strong>The 2nd round counselling for admission 2025 is open from 30/09/25 to 03/10/2025</h4>
