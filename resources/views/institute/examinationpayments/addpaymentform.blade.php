                        ...
                        <form class="form-horizontal" action="{{url('/institute/examinationpayments/checkpayment')}}" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
                            ...
                            <table class="table table-condensed table-bordered">
                                <tr>
                                    ...
                                    <th class="center-text" width="75%">Subject Name</th>
                                    <th class="center-text" width="10%">Subject Type</th>
                                </tr>
                                @php $count = 0; @endphp
                                @foreach($applications as $application)
                                    <tr>
                                        <td class="center-text">
                                            <div class="checkbox">
                                                <label><input type="checkbox" checked name="application_ids[]" id="application_id{{ $count }}" value="{{ $application->id }}" onclick="selectSubject({{ $count }})"></label>
                                            </div>
                                        </td>
                            ...
                            <input type="hidden" id="examfee" value="{{100*$count}}" />
