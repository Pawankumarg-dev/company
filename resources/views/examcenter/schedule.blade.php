            ...
            <div class="col-12">
                ...
                <div class="alert alert-success ">
                    <ul>
                        <li>
                            <p>
                                Kindly read the <a target="_blank" href="{{ url('files/examcenter/guidelines.pdf') }}"> guide
                                    lines</a> for using the portal.
                            </p>
                        </li>

                        <li>Click <a target="_blank" href="{{ url('/files/examcenter/evalutioncenter.pdf') }}"><b>here</b>
                            </a>to download the address of <b>evaluation centers </b> where answer booklets to be sent by
                            end of the day. </li>
                ...
                <div class="alert alert-danger" style="display:none;">
                    ...
                    <p>
                        <b>FAQ:</b> <br>
                    <ul>
                        <li>If student has not choosen alternative paper in the exam application and not reflected in the
                            hallticket, are they eligible to write alternative paper? <b>Yes</b>, if student is having
                    ...
                    @foreach ($schedules as $s)
                        ...
                        <tr>
                            ...
                            <td class="text-center bg-danger">
                                ...
                                <a href="javascript:goto('attn_'+{{ $s->id }},'html')"
                                    class="btn btn-primary btn-xs  ">Print Attendance Sheet</a>
                            ...
                            <td class="text-center bg-danger">
                                ...
                                <span class=" hidden  btn btn-xs btn-primary goto_{{ $s->id }}"
                                    data-url="{{ url('examcenter/schedule') }}/{{ $s->id }}?roomallocation=yes">
                                </span>
                                <a class="btn btn-xs btn-primary  "
                                    href="javascript:goto({{ $s->id }},'html')">Print Room Allocation Sheet</a>
                            </td>
                            <td class="text-center bg-danger">
                        ...
                        @endif --}}
                                ...
                                @if ($date == $sdate && $time > $opentime && $time < $closetime && $s->id == 89)
                                    <a class="btn btn-xs btn-primary    "
                        ...
                        @endif --}}
                                ...
                                @if (($date == $sdate && $attendancetime < $time) || $date > $sdate)
