...
class GenerateNewMarksheet extends Job implements ShouldQueue
{
...
//        $this->supplimentaryService->generateMarksheet($cid);
     ...
     //   echo 'Generated';
        $result = \App\Newresult::where('candidate_id',$cid)->first();
        echo $result;
    ...
    public function generatems($cid,$term){
        ...
        $barcode =  $d->getBarcodeHTML(url("marksheet").$aid.'/'.$rid.'/'.$term.'/25', 'QRCODE',2.5,2.5);
