...
class AttendanceController extends Controller
{
    ...
    public function index(Request $r){
        ...
        $approvedprogrammes  = \App\Allexampaper::where('externalexamcenter_id',$externalexamcenter->id)->where('examschedule_id',$schedule_id)->where('exam_id',$this->exam_id)->groupby('approvedprogramme_id')->get();
    ...
    $applications =  \App\Allexamstudent::where('approvedprogramme_id',$id)
