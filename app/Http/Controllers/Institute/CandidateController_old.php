      ...
      /*  if($request->has('pex')){
       ...
       /* $messages = [
        ...
        if($candidate==null){
            ...
            $candidate->save();
            $candidate->update($request->except('dob','photo','doc_tenth','doc_application','doc_twelveth','doc_community'));
...
//change data update
    //    if($candidate==null){
           //$candidatedatahistory = CandidateDataHistory::create($candidate->all());
           //$editedData = Candidate::where('condition', 'your_condition')->get();
            ...
            $candidatedatahistory->user_id = $candidate->user_id;
            ...
            // $candidatedatahistory->board = $candidate->board;
            // $candidatedatahistory->yop = $candidate->yop;
            // $candidatedatahistory->tmarks = $candidate->tmarks;
            // $candidatedatahistory->omarks = $candidate->omarks;
            // $candidatedatahistory->percentage = $candidate->percentage;
            // $candidatedatahistory->subjects = $candidate->subjects;
            // $candidatedatahistory->edugrade = $candidate->edugrade;

            $candidatedatahistory->save();
      
        //    CandidateDataHistory::create([
        ...
        // 'email' => $request->email,
        // 'photo' => $request->photo,
        // 'doc_mark' => $request->doc_mark,
        // 'doc_dob' => $request->doc_dob,
        // 'doc_disability' => $request->doc_disability,

        // 'doc_community' => $request->doc_community,
        // 'doc_percentage_exception' => $request->doc_percentage_exception,
        ...
        // 'course_percentage' => $request->course_percentage,
        // 'class' => $request->class,
        // 'coursecompleted_status' => $request->coursecompleted_status,
        // 'aadhar' => $request->aadhar,
        // $candidate->update($request->except('enrolmentno','name','fathername','mothername','gender_id','udid','percentage','ews','dob','address','pincode','contactnumber',
        // 'doc_mark','doc_dob','doc_disability','doc_community','doc_percentage_exception','community_id','disability_id','disability_name','city_id','status_id',
        // 'user_id','course_percentage','class','coursecompleted_status','aadhar','photo','doc_tenth','doc_application','doc_twelveth','doc_community'));
        //else{
            // $candidate->subdistrict_id = 0;
            // $candidate->village_id = 0;
            // $candidate->psubdistrict_id = 0;
            ...
            // $comment = ' updated enrolment data, status set to verification pending.  Note: '. $request->comment ;
            // if($request->has('edugrade_1')){
            //     if($edu = \App\CandidateDataHistory::where('edugrade','10th')->where('candidate_id',$candidate->id)->count() > 0){
            //         $edu = \App\CandidateDataHistory::where('edugrade','10th')->where('candidate_id',$candidate->id)->first();
            //         $edu->update([
            //                 'board' => $request->board_1,
            //                 'yop' => $request->yop_1,
            //                 'tmarks' => $request->tmarks_1,
        ...
        // 'address' => $request->address,
            ...
            //}
            // if($request->has('edugrade_2')){
            //     if(\App\CandidateDataHistory::where('edugrade','12th')->where('candidate_id',$candidate->id)->count() > 0){
            //         $edu = \App\CandidateDataHistory::where('edugrade','12th')->where('candidate_id',$candidate->id)->first();
            //         $edu->update([
            //                 'board' => $request->board_2,
            //                 'yop' => $request->yop_2,
            //                 'tmarks' => $request->tmarks_2,
            ...
            // }
            // if($request->has('edugrade_3')||$request->has('board_3')){
            //         if( \App\CandidateDataHistory::whereNotIn('edugrade',['10th','12th'])->where('candidate_id',$candidate->id)->count()>0){
            //         $edu = \App\CandidateDataHistory::whereNotIn('edugrade',['10th','12th'])->where('candidate_id',$candidate->id)->first();
            //         $edu->update([
            //                 'board' => $request->board_3,
            //                 'yop' => $request->yop_3,
            //                 'tmarks' => $request->tmarks_3,
