...
class EnrolmentpaymentController extends Controller
{
    ...
    public function ccavenuePaymentGatewayRequestHandler(Request $request) {
        ...
        $enrolmentfee  = Enrolmentfeepayment::where('candidate_id',$request->id)->first();
        ...
        $merchant_param1 =  '01,' . $request->institute_id . ',' . $request->id;
        ...
        $data += ['redirect_url' => url("/student/enrolmentpayments/ccavenuepaymentgatewayresponsehandler")];
        $data += ['cancel_url' => url("/student/enrolmentpayments/ccavenuepaymentgatewayresponsehandler")];
        $data += ['currency' => 'INR'];
    ...
    public function ccavenuePaymentGatewayResponseHandler(Request $request) {
        ...
        $enrolmentfee  = Enrolmentfeepayment::where('candidate_id',$candidate->id)->first();
