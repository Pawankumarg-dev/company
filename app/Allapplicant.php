...
class Allapplicant extends Model
{
	...
	protected $fillable = [
        ...
        'programme_id','language_id','order_id','amount','additional_amount','payment_status','lookup','additional_payment_status','randstrig','confirmed'
    ];
    
    public function nplustwoexception(){
        return $this->belongsTo('App\Nplustwoexception');
    }

    public function practicalhalltickets(){
        return $this->hasMany('App\Practicalhallticket');
    }

    public function halltickets(){
        return $this->hasMany('App\Hallticket');
    }
    
    public function nplustwoexceptions(){
        return $this->hasMany('App\Nplustwoexception');
    }
    
    public function applications()
    {
    	return $this->hasMany('App\Allapplication','applicant_id');
    }
