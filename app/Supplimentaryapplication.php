...
class Supplimentaryapplication extends Model
{
	protected $fillable = [
        ...
        "hallticket_status",
        'payment_status','external_mark','internal_mark','reevaluation_mark','reevaluation_result_id','supplimentaryapplicant_id',
        'answerbooklet_no'
    ];
    ...
    {
    	return $this->belongsTo('App\Supplimentaryapplicant');
    }
    public function supplimentaryapplicant()
    {
    	return $this->belongsTo('App\Supplimentaryapplicant');
    }
