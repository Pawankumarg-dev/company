<?php
 namespace App\Services\Payments\Smartgateway;
...
class PaymentHandler {
    ...
    public function __construct($paymentHandlerConfig = null) {
        if ($paymentHandlerConfig != null) {
            $this->paymentHandlerConfig = $paymentHandlerConfig;
        } else {


$currentUrl = base_path() . "/smartgateway.pem";
$jsonArray = [
    "API_KEY" => "CBC03EB11414A439E187D461FC2CE3",
    "MERCHANT_ID" => "SG3120",
    "ENABLE_LOGGING" => true,
    "BASE_URL" => "https://smartgatewayuat.hdfcbank.com",
    "PAYMENT_PAGE_CLIENT_ID" => "hdfcmaster",
    "RESPONSE_KEY" => "B13EAC79AD34D8FBAE2EC25192177B",
    "CA_PATH" => $currentUrl
]; 
$json = json_encode($jsonArray, JSON_PRETTY_PRINT);
            ...
            $loggingPath = storage_path('logs/smartgateway.log');
